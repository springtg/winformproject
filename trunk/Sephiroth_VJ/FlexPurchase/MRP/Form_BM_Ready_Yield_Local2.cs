...
{
	public class Form_BM_Ready_Yield_Local2 : COM.PCHWinForm.Form_Top, IOperation
	{
		...
		public Form_BM_Ready_Yield_Local2()
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_BM_Ready_Yield_Local2));
            ...
            this.pnl_head.Controls.Add(this.cmb_DPO);
            ...
            // btn_YieldInspection
            // 
            this.btn_YieldInspection.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(239)))), ((int)(((byte)(248)))), ((int)(((byte)(251)))));
            ...
            this.btn_YieldInspection.Visible = false;
            ...
            this.cmb_DPO.ContentHeight = 16;
            this.cmb_DPO.DeadAreaBackColor = System.Drawing.Color.Empty;
            this.cmb_DPO.EditorBackColor = System.Drawing.SystemColors.Window;
            this.cmb_DPO.EditorFont = new System.Drawing.Font("굴림", 9F);
            this.cmb_DPO.EditorForeColor = System.Drawing.SystemColors.WindowText;
            this.cmb_DPO.EditorHeight = 16;
            this.cmb_DPO.EvenRowStyle = style42;
            this.cmb_DPO.FlatStyle = C1.Win.C1List.FlatModeEnum.System;
            this.cmb_DPO.Font = new System.Drawing.Font("굴림", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cmb_DPO.FooterStyle = style43;
            this.cmb_DPO.GapHeight = 2;
            this.cmb_DPO.HeadingStyle = style44;
            this.cmb_DPO.HighLightRowStyle = style45;
            this.cmb_DPO.ItemHeight = 15;
            this.cmb_DPO.Location = new System.Drawing.Point(109, 62);
            ...
            this.cmb_DPO.OddRowStyle = style46;
            this.cmb_DPO.PartialRightColumn = false;
            ...
            this.cmb_DPO.SelectedStyle = style47;
            this.cmb_DPO.Size = new System.Drawing.Size(210, 20);
            this.cmb_DPO.Style = style48;
            this.cmb_DPO.TabIndex = 5;
            // 
            // lbl_MrpShipNo
            // 
            ...
            // 
            // Form_BM_Ready_Yield_Local2
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
            this.BackColor = System.Drawing.SystemColors.Window;
            this.ClientSize = new System.Drawing.Size(1016, 666);
            this.Controls.Add(this.c1Sizer1);
            this.Name = "Form_BM_Ready_Yield_Local2";
		...
		{						
			...
			lbl_MainTitle.Text = "Local/LLT Yield Check by Yield Process";
			this.Text		   = "Local/LLT Yield Check by Yield Process";
...
//				SELECT_SPB_CMP();
		...
		private void cmb_DPOSetting()
		{
			try
			{		
				DataTable dt_ret = ClassLib.ComVar.Select_DP_DPO_List(cmb_factory.SelectedValue.ToString(), "2" );
				COM.ComCtl.Set_ComboList(dt_ret, cmb_DPO, 0, 0, false, ClassLib.ComVar.ComboList_Visible.Name);   
			}
			catch {}
		}
		...
		private void  SetPrintYield()
		{
			...
			{   
				...
				aHead[2]    = COM.ComFunction.Empty_Combo(cmb_DPO, "");
...
//					}
		...
		private void Event_Click_btn_YieldInspection()
		{
			...
			C1.Win.C1List.C1Combo[] cmb_array = {cmb_factory, cmb_ShipType, cmb_DPO};   
			...
			string mrp_ship_no = cmb_DPO.SelectedValue.ToString(); 
		...
		public DataTable SELECT_SBM_YIELD()
		{
			...
			//01.PROCEDURE명
			MyOraDB.Process_Name = "PKG_SBM_MRP_USAGE_LOCAL.SELECT_SBM_YIELD_DATE";
			...
			MyOraDB.Parameter_Values[1] = COM.ComFunction.Empty_Combo(cmb_DPO, ""); 
