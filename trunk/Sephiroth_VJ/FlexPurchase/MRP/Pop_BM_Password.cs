...
namespace FlexMRP.MRP
{
	...
	/// </summary>
	public class Pop_BM_Password : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_BM_Password));
		...
		private bool CheckPassword()
		{
			try
			{
				...
				string pass_wd = txt_value.Text; 

				//User ID 입력 여부 체크 
				if (pass_wd.Equals(""))
				{
					ClassLib.ComFunction.User_Message("Input Password"); 
					return false;
				} 
				else
				{ 
			...
			{
				ClassLib.ComFunction.User_Message(ex.Message, "Login", MessageBoxButtons.OK, MessageBoxIcon.Warning);
				return false;
			}
		}
