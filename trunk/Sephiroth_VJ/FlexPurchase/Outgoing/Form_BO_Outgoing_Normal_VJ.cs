...
{
	public class Form_BO_Outgoing_Normal_VJ : COM.PCHWinForm.Form_Top
	{
		...
		public Form_BO_Outgoing_Normal_VJ()
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_BO_Outgoing_Normal_VJ));
            ...
            // 
            // Form_BO_Outgoing_Normal_VJ
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
            this.ClientSize = new System.Drawing.Size(1016, 666);
            this.Controls.Add(this.c1Sizer1);
            this.Name = "Form_BO_Outgoing_Normal_VJ";
...
//				}
		...
		{ 
			...
			try
			{
				...
				if (cmb_OutDiv.SelectedValue.ToString() == _OutDiv_Normal)
				{
					...
					if (vPop.ShowDialog() == DialogResult.OK)
					{
						...
						switch (vPrintType)
						{
							...
							case "90": 
								sDir = FlexPurchase.ClassLib.ComFunction.Set_RD_Directory("Form_VJ_upload_for_stock");
								break;
				...
				string sPara;
				if (COM.ComVar.Parameter_PopUp[0].ToString() == "90")
				{
					sPara  = " /rp ";
...
//				}
		...
		{ 
			...
			try
			{
				...
				Thread temp_thread = new Thread(new ThreadStart(Create_Defective));
		...
		private void Btn_UsageProcess()
		{
			...
			try
			{
				...
				Thread temp_thread = new Thread(new ThreadStart(Run_Usage));
		...
		private void Btn_OutsideProcess()
		{
			...
			try
			{
				...
				Thread temp_thread = new Thread(new ThreadStart(Run_Outside));
