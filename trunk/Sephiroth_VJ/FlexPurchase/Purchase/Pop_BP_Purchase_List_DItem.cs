...
namespace FlexPurchase.Purchase
{
	...
	/// </summary>
	public class Pop_BP_Purchase_List_DItem : System.Windows.Forms.UserControl
	{
		...
		public Pop_BP_Purchase_List_DItem()
		{
			// 이 호출은 Windows.Forms Form 디자이너에 필요합니다.
			InitializeComponent();

			// TODO: InitializeComponent를 호출한 다음 초기화 작업을 추가합니다.
            lbl_item.Text = "Date"; // COM.ComVar.Parameter_PopUp[1];
		}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_BP_Purchase_List_DItem));
			...
			this.Name = "Pop_BP_Purchase_List_DItem";
