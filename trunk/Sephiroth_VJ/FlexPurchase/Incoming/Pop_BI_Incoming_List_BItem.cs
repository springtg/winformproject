...
{
	/// <summary>
	/// Pop_BI_Incoming_List_BItem에 대한 요약 설명입니다.
	/// </summary>
	public class Pop_BI_Incoming_List_BItem : System.Windows.Forms.UserControl
	{
		...
		#region 생성자 / 소멸자
		public Pop_BI_Incoming_List_BItem()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_BI_Incoming_List_BItem));
			...
			this.Name = "Pop_BI_Incoming_List_BItem";
		...
		private void Init_Form()
		{
			...
			DataTable vData  = ClassLib.ComVar.Parameter_PopUpTable;
			COM.ComCtl.Set_ComboList(vData, cmb_value, 1, 2, false, 56,0);
