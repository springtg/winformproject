...
{
	public class Pop_BK_Stock_Daily_Print : COM.PCHWinForm.Pop_Small
	{
		...
		public Pop_BK_Stock_Daily_Print()
		{
			InitializeComponent();
		}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pop_BK_Stock_Daily_Print));
		...
		private void printNew()
		{
			try
			{
				...
				{
					case "10":
						mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Daily.mrd";
						break;
					case "20":
						mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Daily2.mrd";
						break;
				}
				

				string Para = " "; 				
				int  iCnt  = COM.ComVar.Parameter_PopUp.Length; 

				Para = 	" /rp ";
				for (int i  = 1 ; i<= iCnt ; i++)
				{				
					Para = Para + "[" + COM.ComVar.Parameter_PopUp[i-1] + "] ";
				}
