...
{
	public class Pop_BK_Stock_Closing_Print : COM.PCHWinForm.Pop_Small
	{
		...
		public Pop_BK_Stock_Closing_Print()
		{
			InitializeComponent();
		}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pop_BK_Stock_Closing_Print));
		...
		private void printNew()
		{
			try
			{
				string printType = cmb_printType.SelectedValue.ToString();
				...
				{
					case "20":
						mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Closing_Factory.mrd";
						break;
					case "30":
						mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Closing_Group.mrd";
						break;
					case "40":
						mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Closing_Item.mrd";
						break;
					case "50":
						mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Closing_Item_Group_All_00.mrd";
						break;
					case "60":
						mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Closing_Item_Group_All.mrd";
						break;
				}
				...
				string stock_ym = ClassLib.ComVar.Parameter_PopUp[1];
				string wh_cd = ClassLib.ComVar.Parameter_PopUp[2]; 
				string wh_name = ClassLib.ComVar.Parameter_PopUp[6]; 
				string item_group = ClassLib.ComVar.Parameter_PopUp[3]; 

				if(printType == "50" || printType == "60")
				{
		...
		{
			string mrd_Filename = @"Report/Material/Form_BK_Stock_Closing.mrd";
			string Para         = " ";
			...
			string stock_ym = COM.ComVar.Parameter_PopUp[1];
			string warehouse = COM.ComVar.Parameter_PopUp[2];
			string item_group = COM.ComVar.Parameter_PopUp[3];
			string item_cd = COM.ComVar.Parameter_PopUp[4];
			string item_name = COM.ComVar.Parameter_PopUp[5];
			string warehouse_name = COM.ComVar.Parameter_PopUp[6];
			string stock_status = COM.ComVar.Parameter_PopUp[7];
			string item_group_name = COM.ComVar.Parameter_PopUp[8];
		...
		private void Init_Form()
		{
			...
			{
				// print type
				DataTable vDt = ClassLib.ComVar.Select_ComCode(COM.ComVar.This_Factory, "SBK12");
