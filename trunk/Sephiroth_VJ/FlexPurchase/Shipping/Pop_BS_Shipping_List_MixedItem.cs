...
namespace FlexPurchase.Shipping
{
	...
	/// </summary>
	public class Pop_BS_Shipping_List_MixedItem : System.Windows.Forms.UserControl
	{
		...
		public Pop_BS_Shipping_List_MixedItem()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_BS_Shipping_List_MixedItem));
			...
			this.cmb_value.PropBag = "<?xml version=\"1.0\"?><Blob><Styles type=\"C1.Win.C1List.Design.ContextWrapper\"><Da" +
				...
				"e9{AlignHorz:Near;}OddRow{}RecordSelector{AlignImage:Center;}Heading{Wrap:True;A" +
				"lignVert:Center;Border:Raised,,1, 1, 1, 1;ForeColor:ControlText;BackColor:Contro" +
				"l;}Style8{}Style10{}Style11{}Style1{}</Data></Styles><Splits><C1.Win.C1List.List" +
			...
			// 
			// Pop_BS_Shipping_List_MixedItem
			// 
			this.BackColor = System.Drawing.Color.White;
			this.Controls.Add(this.groupBox1);
			this.Name = "Pop_BS_Shipping_List_MixedItem";
				...
				if (txt_code.Text.Trim().Length > 0)
				{
					...
					if (vDt.Rows.Count > 0)
					{
						if (_title.Equals(ClassLib.ComVar.Vendor))
							...
							ClassLib.ComCtl.Set_ComboList(vDt, cmb_value, 1, 2, false, 80, 140);
