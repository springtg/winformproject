...
{
	public class Pop_BC_CBD_Master_Print : COM.PCHWinForm.Pop_Small
	{
		...
		public Pop_BC_CBD_Master_Print(string com_cd, string[] arg_param)
		{
			InitializeComponent();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pop_BC_CBD_Master_Print));
		...
		private void btn_apply_Click(object sender, System.EventArgs e)
		{
			try
			{
				int vType = Convert.ToInt32(cmb_print.SelectedValue.ToString());
		...
		private void printType1() 
		{
			...
			sPara += "[" + _param[3] +	"] ";
			sPara += "[" + _param[4] +	"] ";
			sPara += "[" + _param[5] +	"] "; // obs id
			sPara += "[" + _param[6] +	"] "; // purchase user
			//sPara += "[" + _param[7] +	"] "; // vender
			sPara += "[" + "" +	"] "; // vender
