...
namespace FlexVJ_Common.Material_Inspection
{
    public class Pop_BC_Yield_Info : COM.PCHWinForm.Pop_Medium
    {
        ...
        private int _groupCdCol = (int)TBSBC_YIELD_INFO_POP.IxGROUP_CD;
        private int _groupNameCol = (int)TBSBC_YIELD_INFO_POP.IxGROUP_NAME;
        private int _groupName2Col = (int)TBSBC_YIELD_INFO_POP.IxGROUP_NAME2;
        private int _StyleNameCol = (int)TBSBC_YIELD_INFO_POP.IxSTYLE_NAME;
        private int _CompNameCol = (int)TBSBC_YIELD_INFO_POP.IxCOMP_NAME;
        ...
        private void InitializeComponent()
        {
            ...
            this.lbl_calcType.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.cmb_calcType.CaptionStyle = style25;
            ...
            this.cmb_calcType.EditorFont = new System.Drawing.Font("Microsoft Sans Serif", 9F);
            this.cmb_calcType.EditorForeColor = System.Drawing.SystemColors.WindowText;
            this.cmb_calcType.EditorHeight = 16;
            this.cmb_calcType.EvenRowStyle = style26;
            this.cmb_calcType.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cmb_calcType.FooterStyle = style27;
            this.cmb_calcType.HeadingStyle = style28;
            this.cmb_calcType.HighLightRowStyle = style29;
            ...
            this.cmb_calcType.OddRowStyle = style30;
            ...
            this.cmb_calcType.SelectedStyle = style31;
            this.cmb_calcType.Size = new System.Drawing.Size(195, 20);
            this.cmb_calcType.Style = style32;
            ...
            this.cmb_style_cd.CaptionStyle = style33;
            ...
            this.cmb_style_cd.EvenRowStyle = style34;
            ...
            this.cmb_style_cd.FooterStyle = style35;
            this.cmb_style_cd.HeadingStyle = style36;
            this.cmb_style_cd.HighLightRowStyle = style37;
            ...
            this.cmb_style_cd.OddRowStyle = style38;
            ...
            this.cmb_style_cd.SelectedStyle = style39;
            this.cmb_style_cd.Size = new System.Drawing.Size(138, 21);
            this.cmb_style_cd.Style = style40;
        ...
        private void Return_Item_Data()
        {
            ...
            try
            {
                ...
                DataColumn[] dc = new DataColumn[15];
                ...
                dc[10] = new DataColumn("style_name", Type.GetType("System.String"));
                dc[11] = new DataColumn("comp_name", Type.GetType("System.String"));
                dc[12] = new DataColumn("group_cd", Type.GetType("System.String"));
                dc[13] = new DataColumn("group_name", Type.GetType("System.String"));
                dc[14] = new DataColumn("group_name2", Type.GetType("System.String"));
                ...
                for (int vRow = fgrid_yield.Rows.Fixed; vRow < fgrid_yield.Rows.Count; vRow++)
                {
                    if ((bool)fgrid_yield[vRow, _chkApplyCol])
                    {
                        ...
                        if (vFlag == 0)
                        {
                            ...
                            newRow[10] = fgrid_yield[vRow, _StyleNameCol].ToString();				// style name
                            newRow[11] = fgrid_yield[vRow, _CompNameCol].ToString();				// Comp name
                            newRow[12] = fgrid_yield[vRow, _groupCdCol].ToString();				// group cd
                            newRow[13] = fgrid_yield[vRow, _groupNameCol].ToString();				// group name 
                            newRow[14] = fgrid_yield[vRow, _groupName2Col].ToString();				// group name 2
        ...
        private void Init_Form()
        {
            ...
            // 그리드 설정
            fgrid_yield.Set_Grid("SMI_YIELD_INFO_POP", "1", 1, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, false);
        ...
        public DataTable Select_YieldList(string arg_factory, string arg_stylecode, string arg_flag)
        {
            ...
            //01.PROCEDURE명
            MyOraDB.Process_Name = "pkg_smi_mat_ins.SELECT_SBC_YIELD_INFO_POP";
        ...
        public DataTable Select_YieldList(string arg_factory, string arg_stylecode, string arg_flag, string arg_item)
        {
            ...
            //01.PROCEDURE명
            MyOraDB.Process_Name = "pkg_smi_mat_ins.SELECT_SBC_YIELD_INFO_POP_LIKE";
