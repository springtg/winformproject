...
namespace FlexVJ_Common.DPUFE
{
	public class Form_Plan_Simulation : COM.VJ_CommonWinForm.Form_Top
	{
		...
		private void InitializeComponent()
		{
			...
			this.dpickDate_To.ShowUpDown = true;
			...
			this.dpickDate_From.ShowUpDown = true;
...
//				string data2=Convert.ToString(dt.Rows[0][2]);
				...
				string data1= dt.Rows[0][1].ToString();
				string data2= dt.Rows[0][2].ToString();
				...
				{
					if(data1.Trim()==Convert.ToString(fgrid_main.Rows[0][i]).Trim())
					{
						indexCol=i;
						break;
					}
...
//			else
//			{
//				MessageBox.Show("ko xac dinh dc ngay complete");
//			}
		}
				...
				if (dt.Rows.Count > 0)
				{
					for (int i = 0; i < dt.Rows.Count; i ++ )
					{
						...
						{							
							...
							string l_value_2 = ConvertOBS_ID(_dtime.Year,_dtime.Month);
							l_Str = GET_CAPA_QTY(cmb_Factory.SelectedValue.ToString(),
								_dtime.ToString("yyyyMMdd"), l_value_2.Substring(0,2), cbm_Line.SelectedValue.ToString()).ToString();
						}
