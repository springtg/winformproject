...
{
	public class Form_TI_Stuffing_New : COM.TradeWinForm.Form_Top
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel2.Size = new System.Drawing.Size(1008, 438);
			...
			this.fgrid_main.Size = new System.Drawing.Size(1008, 438);
			...
			this.pnl_head.Size = new System.Drawing.Size(1008, 136);
			...
			this.txtBooking.Font = new System.Drawing.Font("굴림", 9F);
			...
			this.btn_Origin.Font = new System.Drawing.Font("굴림", 9F);
			this.btn_Origin.ImageIndex = 0;
			this.btn_Origin.ImageList = this.img_LongButton;
			this.btn_Origin.Location = new System.Drawing.Point(899, 104);
			...
			this.btn_booking.Font = new System.Drawing.Font("굴림", 9F);
			this.btn_booking.ImageIndex = 0;
			this.btn_booking.ImageList = this.img_LongButton;
			this.btn_booking.Location = new System.Drawing.Point(798, 104);
			...
			this.lbl_booking.Font = new System.Drawing.Font("굴림", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.pic_head3.Location = new System.Drawing.Point(992, 120);
			...
			this.dpick_booking_date_from.Font = new System.Drawing.Font("굴림", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.dpick_booking_date_to.Font = new System.Drawing.Font("굴림", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.lbl_booking_date.Font = new System.Drawing.Font("굴림", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
		...
		private int _colT_LEVEL			     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxT_LEVEL;
		private int _colCHK			         = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCHK;
		private int _colFACTORY 		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFACTORY;
		private int _colSTYLE_CD		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxSTYLE_CD;
		private int _colSTYLE_NM		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxSTYLE_NM;
		private int _colINVOICE_DATE	     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxSTYLE_CD;
		private int _colINVOICE_NO		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxINVOICE_NO;
		private int _colSHIP_DATE		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxGEN_NM;
		private int _colGEN_NM			     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxGEN_NM;
		private int _colORDER_SHOE_QTY       = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxORDER_SHOE_QTY;
		private int _colINVOICE_SHOE_QTY     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxINVOICE_SHOE_QTY;
		private int _colINVOICE_CT_QTY       = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxINVOICE_CT_QTY;
		private int _colPO_NO                = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxPO_NO;
		private int _colPO_ITEM              = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxPO_ITEM;
		private int _colPO_NO_K              = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxPO_NO_K;
		private int _colPO_ITEM_K            = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxPO_ITEM_K;		
		private int _colTRADE_CS_FOB         = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxTRADE_CS_FOB;
		private int _colTRADE_FACTORY_FOB    = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxTRADE_FACTORY_FOB;
		private int _colAMOUNT               = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxAMOUNT;										     
		private int _colCI_WEIGHT     	     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCI_WEIGHT;
		private int _colCI_NO      	         = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCI_NO;
		private int _colCCIB      	         = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCCIB;
		
		private int _colCBM     	         = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCBM;
		private int _colNET_WEIGHT     	     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxNET_WEIGHT;
		private int _colGROSS_WEIGHT         = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxGROSS_WEIGHT;
		private int _colORD_DATE             = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxORD_DATE;

		private int _colPO_TYPE_NM           = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxPO_TYPE_NM;										     
		private int _colBOOKING_NO           = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxBOOKING_NO;
		private int _colBOOKING_DATE         = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxBOOKING_DATE;
		private int _colBOOKING_REVISE_DATE  = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxBOOKING_REVISE_DATE;
		private int _colDELIVERY_DATE        = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxDELIVERY_DATE;		
		private int _colFFS_STENCIL_DEST     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFFS_STENCIL_DEST;										     
		private int _colBUKRS			     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxBUKRS;
		private int _colFFS_SOLDTO_CD	     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFFS_SOLDTO_CD;
		private int _colFFS_NAME2		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFFS_NAME2;
		private int _colFFS_NAME2_1		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFFS_NAME2_1;
		private int _colNOTIFY_KEY		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxNOTIFY_KEY;
		private int _colNOTIFY_NAME1	     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxNOTIFY_NAME1;										     
		private int _colCUST_XREF		     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCUST_XREF;
		private int _colWERKS			     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxWERKS;
		private int _colFFS_SHP_TO_ACCT	     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFFS_SHP_TO_ACCT;		
		private int _colFFS_STENCIL_SHIPTO	 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFFS_STENCIL_SHIPTO;
		private int _colFFS_STENCIL_ORIGIN	 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxFFS_STENCIL_ORIGIN;		
		private int _colTRANS_CD			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxTRANS_CD;
		private int _colTRANS_NM			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxTRANS_NM;
		private int _colLC_NO				 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxLC_NO;
		private int _colM_BL_NO				 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxM_BL_NO;
		private int _colPL_NO				 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxPL_NO;
		private int _colAFS_CATEGORY		 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxAFS_CATEGORY;
		private int _colCUST_PO_NO			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCUST_PO_NO;
		private int _colRGAC_DATE			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxRGAC_DATE;
		private int _colOGAC_DATE			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxOGAC_DATE;
		private int _colCGAC_DATE			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxCGAC_DATE;
		private int _colBGAC_DATE			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxBGAC_DATE;
		private int _colAIR_CHARGES			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxAIR_CHARGES;
		private int _colSIZE_DIV			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxSIZE_DIV;
		private int _colSIZE_FROM			 = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxSIZE_FROM;
		private int _colSIZE_TO			     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxSIZE_TO;
		private int _colREMARK			     = (int)ClassLib.TBSTM_INVOICE_BOOKING_2.IxREMARK;
		...
		private void fgrid_main_Click(object sender, System.EventArgs e)
		{
			...
			if (sLevel.Equals("1"))
			{
				...
				else if ((iCol == _colCHK)||(iCol == _colORD_DATE)||(iCol == _colBOOKING_NO)||(iCol == _colBOOKING_DATE)||(iCol == _colBOOKING_REVISE_DATE)||
					     (iCol == _colDELIVERY_DATE)||(iCol == _colFFS_NAME2)||(iCol == _colFFS_NAME2_1)||(iCol == _colAIR_CHARGES)||(iCol == _colLC_NO)||
					     (iCol == _colCCIB)||(iCol == _colPL_NO)||(iCol == _colREMARK))
				{
					fgrid_main.Rows[iRow].AllowEditing   = true;
				}
				else
			...
			else
			{
				...
				else if ((iCol == _colCHK)||(iCol == _colCBM)||(iCol == _colGROSS_WEIGHT)||(iCol == _colNET_WEIGHT)||(iCol == _colBGAC_DATE)||
						 (iCol == _colWERKS)||(iCol == _colFFS_SHP_TO_ACCT)||(iCol == _colFFS_SHP_TO_ACCT)||(iCol == _colFFS_STENCIL_DEST)||
						 (iCol == _colFFS_STENCIL_SHIPTO)||(iCol == _colFFS_STENCIL_ORIGIN))
				{
					fgrid_main.Rows[iRow].AllowEditing   = true;
				}
				else if ((iCol == _colFFS_SOLDTO_CD)&&(fgrid_main.Cols[iCol].ComboList == "...")&&(_temp_row==iRow)&&(_temp_col==iCol))
				{
					Get_Consignee_Data();
		...
		public bool SAVE_STM_INVOICE(bool doExecute)
		{
			try
			{
				...
				//01.PROCEDURE명
				MyOraDB.Process_Name = "PKG_STM_INVOICE_BOOKING.SAVE_STM_INVOICE_BOOKING_2";
				...
				MyOraDB.Parameter_Name[39] = "ARG_CONSIGNEE_NM3";
				MyOraDB.Parameter_Name[40] = "ARG_CONSIGNEE_NM4";
				MyOraDB.Parameter_Name[41] = "ARG_REMARK";
				MyOraDB.Parameter_Name[42] = "ARG_BGAC_DATE";
				MyOraDB.Parameter_Name[43] = "ARG_BOOKING_REVISE_DATE";
				MyOraDB.Parameter_Name[44] = "ARG_UPD_USER";
				...
				for (int iRow = fgrid_main.Rows.Fixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					if(fgrid_main[iRow, 0].ToString() != "")
					{
						...
						if (fgrid_main[iRow, _colT_LEVEL].ToString() == "1")
						{
							...
							MyOraDB.Parameter_Values[para_ct+42] = "";
							MyOraDB.Parameter_Values[para_ct+43] = ((fgrid_main[iRow, _colBOOKING_REVISE_DATE] == null)||(fgrid_main[iRow, _colBOOKING_REVISE_DATE].ToString().Length == 0)) ? "________" : Convert.ToDateTime(fgrid_main[iRow, _colBOOKING_REVISE_DATE]).ToString("yyyyMMdd");
						}
						else
						{
							...
							MyOraDB.Parameter_Values[para_ct+42] = ((fgrid_main[iRow, _colBGAC_DATE] == null)||(fgrid_main[iRow, _colBGAC_DATE].ToString().Length == 0)) ? "________" : Convert.ToDateTime(fgrid_main[iRow, _colBGAC_DATE]).ToString("yyyyMMdd");
							MyOraDB.Parameter_Values[para_ct+43] = "";
						}

						MyOraDB.Parameter_Values[para_ct+ 8] = (fgrid_main[iRow,  _colCI_WEIGHT]          == null) ? "0" : fgrid_main[iRow, _colCI_WEIGHT].ToString();
						...
						MyOraDB.Parameter_Values[para_ct+26] = (fgrid_main[iRow,  _colTRADE_CS_FOB]       == null) ? "" : fgrid_main[iRow, _colTRADE_CS_FOB].ToString();
						MyOraDB.Parameter_Values[para_ct+27] = (fgrid_main[iRow,  _colTRADE_FACTORY_FOB]  == null) ? "" : fgrid_main[iRow, _colTRADE_FACTORY_FOB].ToString();
						...
						MyOraDB.Parameter_Values[para_ct+39] = (fgrid_main[iRow,  _colFFS_NAME2]      == null) ? "" : fgrid_main[iRow, _colFFS_NAME2].ToString();
						MyOraDB.Parameter_Values[para_ct+40] = (fgrid_main[iRow,  _colFFS_NAME2_1]    == null) ? "" : fgrid_main[iRow, _colFFS_NAME2_1].ToString();
						MyOraDB.Parameter_Values[para_ct+41] = (fgrid_main[iRow,  _colREMARK]         == null) ? "" : fgrid_main[iRow, _colREMARK].ToString();

						MyOraDB.Parameter_Values[para_ct+44] = COM.ComVar.This_User;
			...
			try
			{
				...
				for (int iRow = _Rowfixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					...
					if (fgrid_main[iRow, _colCHK].ToString() == "True")
					{
						...
						MyOraDB.Parameter_Values[para_ct+ 4] = Convert.ToDateTime(fgrid_main[iRow, _colBOOKING_DATE]).ToString("yyyyMMdd");
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "Booking Management [SS, OR, QQ]";
			this.Text		   = "Booking";


			// grid set
			fgrid_main.Set_Grid("STM_INVOICE_BOOKING", "2", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
		...
		private void Tbtn_SearchProcess()
		{
			try
			{
				...
				string vProcedure     = "PKG_STM_INVOICE_BOOKING.SELECT_STM_INVOICE_BOOKING_2";
		...
		private void Display_FlexGrid(DataTable arg_dt)
		{
			...
			for (int iRow = 0 ; iRow < iCount ; iRow++)
			{
				...
				{										
					...
					fgrid_main.Cols[_colRGAC_DATE].Style.Format           = "yyyy-MM-dd";
					fgrid_main.Cols[_colOGAC_DATE].Style.Format           = "yyyy-MM-dd";
					fgrid_main.Cols[_colCGAC_DATE].Style.Format           = "yyyy-MM-dd";
		...
		private void GridSetColor()
		{
			...
			{				
				...
				for (int iRow = fgrid_main.Rows.Fixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					...
					vRange_2    = fgrid_main.GetCellRange(iRow, _colTRANS_CD,		   iRow,   _colCCIB);
					vRange_3   = fgrid_main.GetCellRange(iRow, _colCBM, 			   iRow,   _colNET_WEIGHT);
					vRange_4   = fgrid_main.GetCellRange(iRow, _colORD_DATE, 	       iRow,   _colDELIVERY_DATE);
					vRange_5   = fgrid_main.GetCellRange(iRow, _colFFS_SOLDTO_CD,      iRow,   _colNOTIFY_NAME1);
					vRange_6   = fgrid_main.GetCellRange(iRow, _colAIR_CHARGES,        iRow,   fgrid_main.Cols.Count-1);					
		...
		private void Grid_AfterEditProcess()
		{
			...
			if ((iCol == _colINVOICE_SHOE_QTY)||(iCol == _colTRADE_CS_FOB)||(iCol == _colTRADE_FACTORY_FOB))
			{
				if (iCol == _colTRADE_CS_FOB)
				{
					...
					if (fgrid_main[iRow, _colFACTORY].ToString() == "VJ")
						dTRADE_FACTORY_FOB = System.Math.Round(dTRADE_CS_FOB * (_mediation_margin/100), 2);
			...
			else if ((iCol == _colGROSS_WEIGHT)||(iCol == _colNET_WEIGHT)||(iCol == _colCBM))
			{
				Calculate_Total();
			}
		...
		private void Calculate_Total()
		{
			...
			for (iRow_H=iRow_Tag; iRow_H<fgrid_main.Rows.Count; iRow_H++)
			{
				...
				{	
					...
					if (fgrid_main[iRow, _colCBM] != null)
						dCBM      += Convert.ToDouble(fgrid_main[iRow, _colCBM].ToString());

					if (fgrid_main[iRow, _colGROSS_WEIGHT] != null)
						dG_Weight += Convert.ToDouble(fgrid_main[iRow, _colGROSS_WEIGHT].ToString());

					if (fgrid_main[iRow, _colNET_WEIGHT] != null)
						dN_Weight += Convert.ToDouble(fgrid_main[iRow, _colNET_WEIGHT].ToString());
				}

				fgrid_main[iRow_H, _colCBM]          = dCBM.ToString();
				fgrid_main[iRow_H, _colGROSS_WEIGHT] = dG_Weight.ToString();
				fgrid_main[iRow_H, _colNET_WEIGHT]   = dN_Weight.ToString();
		...
		private void PRINT_INVOICE(string arg_report_request_key, string arg_job_name)
		{
			...
			if (arg_job_name == "BOOKING")
			{
				...
				{
					if (cmb_trans.SelectedValue.ToString() == "AF")
				...
				{
					if (_trans_cd == "AF")
						sDir = FlexTrade.ClassLib.ComFunction.Set_RD_Directory("Form_TI_Booking_AF_VJ_Irregular");
					else
						sDir = FlexTrade.ClassLib.ComFunction.Set_RD_Directory("Form_TI_Booking_VL_VJ_Irregular");				
				}
		...
		private void fgrid_main_KeyPressEdit(object sender, C1.Win.C1FlexGrid.KeyPressEditEventArgs e)
		{
			...
			else if (iCol == _colORD_DATE)
			{
				if (e.KeyChar == 13)
				{
					fgrid_main.Row += 1;
					fgrid_main.Col  = _colCBM;
				}
			}
