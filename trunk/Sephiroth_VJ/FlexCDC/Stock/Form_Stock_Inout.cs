...
{
	public class Form_Stock_Inout : COM.PCHWinForm.Form_Top
	{
		...
		private System.Windows.Forms.Label lbl_inout_ymd;
		private System.Windows.Forms.DateTimePicker dtp_inout_ymd;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_Stock_Inout));
			...
			this.lbl_inout_ymd = new System.Windows.Forms.Label();
			this.dtp_inout_ymd = new System.Windows.Forms.DateTimePicker();
			...
			this.lbl_MainTitle.Text = "PCC_Stock_InOut";
			// 
			// image_List
			// 
			...
			this.pnl_Top.Controls.Add(this.cmb_location);
			...
			this.pnl_SearchImage.Controls.Add(this.lbl_inout_ymd);
			this.pnl_SearchImage.Controls.Add(this.dtp_inout_ymd);
			...
			this.txt_material_name.TabIndex = 353;
			...
			this.lbl_material_name.Location = new System.Drawing.Point(8, 58);
			...
			this.lbl_color_name.Location = new System.Drawing.Point(664, 58);
			...
			this.txt_color_name.Location = new System.Drawing.Point(765, 58);
			...
			// lbl_inout_ymd
			// 
			this.lbl_inout_ymd.Font = new System.Drawing.Font("Verdana", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.lbl_inout_ymd.ImageIndex = 0;
			this.lbl_inout_ymd.ImageList = this.img_Label;
			this.lbl_inout_ymd.Location = new System.Drawing.Point(664, 36);
			this.lbl_inout_ymd.Name = "lbl_inout_ymd";
			this.lbl_inout_ymd.Size = new System.Drawing.Size(100, 21);
			this.lbl_inout_ymd.TabIndex = 322;
			this.lbl_inout_ymd.Text = "Date";
			this.lbl_inout_ymd.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// dtp_inout_ymd
			// 
			this.dtp_inout_ymd.CustomFormat = "yyyyMMdd";
			this.dtp_inout_ymd.Font = new System.Drawing.Font("Verdana", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.dtp_inout_ymd.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			this.dtp_inout_ymd.Location = new System.Drawing.Point(765, 36);
			this.dtp_inout_ymd.Name = "dtp_inout_ymd";
			this.dtp_inout_ymd.Size = new System.Drawing.Size(213, 22);
			this.dtp_inout_ymd.TabIndex = 486;		
			// 
			// picb_TM
			// 
			...
			this.lbl_location.Location = new System.Drawing.Point(336, 36);
			this.lbl_location.Name = "lbl_location";
			this.lbl_location.Size = new System.Drawing.Size(100, 21);
			this.lbl_location.TabIndex = 487;
			...
			this.cmb_location.Location = new System.Drawing.Point(445, 36);
			...
			this.Name = "Form_Stock_Inout";
			this.Text = "PCC_Stock_InOut";
			this.Load += new System.EventHandler(this.Form_Stock_Inout_Load);
		...
		private void  Init_Form()
		{
			...
			{				
				...
				//TBSXD_MRP_ITEM_01
				fgrid_stock.Set_Grid_CDC("SXK_STOCK_INOUT", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, false); 
				fgrid_stock.Set_Action_Image(img_Action);
				fgrid_stock.Tree.Column = (int)ClassLib.TBSXK_STOCK_INOUT.lxINOUT_YMD + 1;	
		...
		private  void  DisPlay_Grid(DataTable arg_dt, COM.FSP arg_fgrid)
		{
			...
			for(int i = 0; i < arg_dt.Rows.Count; i++)
			{
				...
				int tree_level    = int.Parse(arg_dt.Rows[i].ItemArray[(int)ClassLib.TBSXK_STOCK_INOUT.lxLEVEL].ToString());				
				arg_fgrid.Rows.InsertNode(arg_fgrid.Rows.Count, tree_level);	
					
				#region Level에 따른 Grid Edit & BackColor 설정 
				if(tree_level == 1)
				{					
					arg_fgrid.Rows[arg_fgrid.Rows.Count -1].StyleNew.BackColor = Color.White;						
				}
			...
			fgrid_stock.AllowMerging = AllowMergingEnum.Free;
		}
		#endregion 
		...
		{			
			try
			{
				...
				DataTable  dt_list = Select_Stock_InOut();
		...
		#region  DB컨넥트
		private DataTable Select_Stock_InOut()
		{
			string Proc_Name = "PKG_SXK_STOCK_01_SELECT.SELECT_SXI_IN_OUT_LIST";
			...
			MyOraDB.Parameter_Values[2] = MyComFunction.ConvertDate2DbType( dtp_inout_ymd.Value.ToString()).ToString().Substring(0,8);
		...
		private void Form_Stock_Inout_Load(object sender, System.EventArgs e)
		{
