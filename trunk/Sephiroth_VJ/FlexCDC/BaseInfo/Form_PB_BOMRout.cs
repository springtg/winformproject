...
namespace FlexCDC.BaseInfo
{
	public class Form_PB_BOMRout : COM.APSWinForm.Form_Top
	{
		...
		private void InitializeComponent()
		{
			...
			this.addflow_BOM.AutoScrollMinSize = new System.Drawing.Size(1156, 571);
...
//				Set_Rout_Yet(); 
		...
		{ 
			...
			fgrid_BOM.Set_Grid("P_STANDARD_BOM", "1", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, true);
		...
		{ 
			...
			try
			{ 
				string process_name = "PKG_SXB_P_BOM.SELECT_STDBOM_ROUT";
		...
		private void  Select_StdRout_Node(string arg_cmpcd, Lassalle.Flow.Node arg_node)
		{
			...
			try
			{ 
				string process_name = "PKG_SXB_P_ROUT.SELECT_BOMROUT_NODE";
		...
		private void Select_StdRout_Link(string arg_cmpcd)
		{
			...
			try
			{ 
				string process_name =  "PKG_SXB_P_ROUT.SELECT_BOMROUT_LINK";
		...
		{  
			...
			try
			{
                ...
                MyOraDB.Process_Name = "PKG_SXB_P_ROUT.DELETE_SXB_PJ_ROUT_BOM";
...
//			cmb_RoutType.SelectedIndex = -1;
		...
		private void menuItem_UpdateRout_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				Pop_SetBomRoutInfo pop_form = new Pop_SetBomRoutInfo();
		...
		private void menuItem_SetRout_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				{ 
					...
					Pop_PB_Rout pop_form = new Pop_PB_Rout(); 
					ClassLib.ComVar.Parameter_PopUp = new string[] {factory, bom_cd, cmp_cd, rout_type}; 
					pop_form.ShowDialog();
		...
		{ 
			...
			{  
				...
				string process_name = "PKG_SXB_ROUT.UPDATE_PCARD_YN";
