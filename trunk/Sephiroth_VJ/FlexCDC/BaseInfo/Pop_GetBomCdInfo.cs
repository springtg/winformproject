...
namespace FlexCDC.BaseInfo
{
	public class Pop_GetBomCdInfo : COM.APSWinForm.Pop_Large
	{
		...
		private void InitializeComponent()
		{
			...
			this.obar_Main.SelectedIndex = 2;
			...
			this.cmb_MFactory.Enabled = false;
			...
			this.obarpg_Style.Location = new System.Drawing.Point(0, 0);
			this.obarpg_Style.Name = "obarpg_Style";
			this.obarpg_Style.Size = new System.Drawing.Size(0, 0);
			...
			this.pnl_Style.Size = new System.Drawing.Size(0, 0);
			...
			this.cmb_SFactory.Enabled = false;
			...
			this.obarpg_Line.Location = new System.Drawing.Point(0, 60);
			this.obarpg_Line.Name = "obarpg_Line";
			this.obarpg_Line.Size = new System.Drawing.Size(672, 296);
			...
			this.pnl_Line.Size = new System.Drawing.Size(672, 296);
			...
			this.cmb_LFactory.Enabled = false;
		...
		private void Init_Form()
		{
			...
			ClassLib.ComCtl.Set_Factory_List(dt_ret, cmb_MFactory, 0, 1, false, COM.ComVar.ComboList_Visible.Code);
			ClassLib.ComCtl.Set_Factory_List(dt_ret, cmb_SFactory, 0, 1, false, COM.ComVar.ComboList_Visible.Code);
			ClassLib.ComCtl.Set_Factory_List(dt_ret, cmb_LFactory, 0, 1, false, COM.ComVar.ComboList_Visible.Code);

            fgrid_Model.Set_Grid("SXB_MODEL_CODE", "3", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, true);
            fgrid_Style.Set_Grid("SXB_STYLE_CODE", "3", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, true);
            fgrid_Line.Set_Grid("SXB_LINE_CODE", "2", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, true);
...
//			}
		...
		private DataTable Select_Model_Year()
		{
			...
			try
			{ 
				string process_name = "PKG_SPB_MODEL.SELECT_MODEL_YEAR";
		...
		private DataTable Select_Model_List()
		{
			...
			try
			{ 
				string process_name = "PKG_SPB_MODEL.SELECT_MODEL_LIST";
		...
		private DataTable Select_Model_CmbList()
		{
			...
			try
			{ 
				string process_name = "PKG_SPB_MODEL.SELECT_MODEL_CMBLIST";
		...
		private DataTable Select_Style_List()
		{
			...
			try
			{ 
				string process_name = "PKG_SPB_STYLE.SELECT_SPB_STYLE_LIKE";
