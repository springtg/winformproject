...
{
    public partial class Form_Pur_Order_New : COM.PCHWinForm.Form_Top
    {
        #region 사용자 정의 변수
        ...
        #region Form Loading
        private void Form_Pur_Order_New_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void Init_Form()
        {
            ...
            #region Grid Setting
            fgrid_order.Set_Grid_CDC("SXP_PUR_ORDER_NEW", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, false);
            ...
            fgrid_order.Tree.Column = (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxMAT_NAME;
            #endregion
        ...
        private void Display_Grid(DataTable arg_dt)
        {
            ...
            {
                int _level = int.Parse(arg_dt.Rows[i].ItemArray[(int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL].ToString());
                ...
                if (_level.Equals(1))
                {                    
                    string _status = fgrid_order[fgrid_order.Rows.Count - 1, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxSTATUS].ToString();
        ...
        private void SAVE_PUR_ORDER()
        {
            ...
            //01.PROCEDURE명
            MyOraDB.Process_Name = "PKG_SXP_PUR_02.SAVE_SXP_PUR_HEAD";
            ...
            {
                string _div = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxDIVISION].ToString().Trim();
                if (!_div.Equals(""))
                {       
                    vRow++;                  
                }
            ...
            for (int i = fgrid_order.Rows.Fixed; i < fgrid_order.Rows.Count; i++)
            {
                string _level = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL].ToString().Trim();
                string _div = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxDIVISION].ToString().Trim();
                
                if (_level.Equals("2") || _div.Equals(""))
                    continue;

                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxDIVISION].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxBAR_CODE].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_SEQ].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxRTA_YMD].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxETC_YMD].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxPUR_DIV_E].ToString().Trim();

                string _common_yn = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxCOMMON_YN].ToString().ToUpper().Trim();
                ...
                string _price_yn = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxPRICE_YN_V].ToString().ToUpper().Trim();
                if(_price_yn.Equals("TRUE"))
                    _price_yn = "Y";
                else
                    _price_yn = "N";
                MyOraDB.Parameter_Values[vCnt++] = _price_yn;
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxTRANSPORT_TYPE].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVALUE_PUR].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxPUR_CURRENCY].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxPUR_PRICE].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxCBD_CURRCNCY].ToString().Trim();
                MyOraDB.Parameter_Values[vCnt++] = fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxCBD_PRICE].ToString().Trim();
        ...
        private void tbtn_Delete_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
        {
            try
            {
                ...
                {
                    string _lev = fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL].ToString();

                    if (_lev.Equals("1"))
                    {
                        fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxDIVISION] = "D";
                    } 
                }
            }
            catch
        ...
        private void tbtn_Confirm_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
        {
            try
            {
                ...
                for (int i = fgrid_order.Rows.Fixed; i < fgrid_order.Rows.Count; i++)
                {
                    string vendor = (fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_NAME] == null) ? "" : fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_NAME].ToString().Trim();
                    string lev = (fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL] == null) ? "" : fgrid_order[i, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL].ToString().Trim();
        ...
        private void mnu_vendor_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (pop_vendor.save_flg)
                {
                    for (int i = 0; i < sct_rows.Length; i++)
                    {
                        if (fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL].ToString() == "1")
                        {
                            fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_SEQ]  = COM.ComVar.Parameter_PopUp[0];
                            fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_NAME] = COM.ComVar.Parameter_PopUp[1];
        ...
        private void fgrid_order_AfterEdit(object sender, RowColEventArgs e)
        {
            ...
            for (int i = 0; i < sct_rows.Length; i++)
            {
                string _lev = fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL].ToString().Trim();

                if (_lev.Equals("1"))
                {
                    fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxDIVISION] = "U";
                    fgrid_order[sct_rows[i], sct_col] = fgrid_order[sct_row, sct_col].ToString().Trim();

                    if (sct_col.Equals((int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_NAME))
                        fgrid_order[sct_rows[i], (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_SEQ] = fgrid_order[sct_row, sct_col].ToString().Trim();
                }
            }

            if (sct_col == (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVALUE_PUR)
            {
                ClassLib.ComFunction.NextRow_Focus_FlexGrid(fgrid_order, fgrid_order.Selection.r1, fgrid_order.Selection.c1, true, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxT_LEVEL, "1");
            }
        }
        private void fgrid_order_MouseMove(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                //{
                //    if (!fgrid_order[sct_row, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxSTATUS].ToString().Equals("C") && sct_col == (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_NAME)
                //    {
                //        string vMatcd = fgrid_order[fgrid_order.Selection.r1, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxMAT_CD].ToString();
                //        string vPurno = fgrid_order[fgrid_order.Selection.r1, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxPUR_NO].ToString();
            ...
            try
            {
                ...
                if (sct_row >= fgrid_order.Rows.Fixed)
                {
                    if (!fgrid_order[sct_row, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxSTATUS].ToString().Equals("C") && sct_col == (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxVEN_NAME)
                    {
                        ...
                        string vMatcd = fgrid_order[sct_row, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxMAT_CD].ToString();
                        string vPurno = fgrid_order[sct_row, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxPUR_NO].ToString();
                    ...
                    if (fgrid_order[sct_row, (int)ClassLib.TBSXP_PUR_ORDER_NEW.IxSTATUS].ToString().Equals("C"))
                    {
                        mnu_release.Enabled = true;
