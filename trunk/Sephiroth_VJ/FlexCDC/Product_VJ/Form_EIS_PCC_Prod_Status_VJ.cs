...
{
    public partial class Form_EIS_PCC_Prod_Status_VJ : COM.APSWinForm.Form_Top
    {
        ...
        #region Resource
        public Form_EIS_PCC_Prod_Status_VJ()
        {
            InitializeComponent();
        ...
        private void Init_Form()
        {
            ...
            fgrid_year.Tree.Column = (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxITEM;
            ...
            fgrid_month.Tree.Column = (int)ClassLib.TBEDM_PCC_PROD_DAY_VJ.IxTITLE;
        ...
        private void Display_Grid_Month()
        {
            ...
            fgrid_year.Cols.Count = (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxMAX_CNT;
            ...
            for (int col_cnt = 0; col_cnt < dt_month_grid.Rows.Count; col_cnt++)
            {
                ...
                fgrid_year[fgrid_year.Rows.Fixed - 2, (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxMAX_CNT + col_cnt] = dt_month_grid.Rows[col_cnt].ItemArray[0].ToString();
                fgrid_year[fgrid_year.Rows.Fixed - 1, (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxMAX_CNT + col_cnt] = dt_month_grid.Rows[col_cnt].ItemArray[1].ToString();
            }
            ...
            {
                int lev = int.Parse(dt_month.Rows[i].ItemArray[(int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxT_LEV].ToString());

                string op_cd    = dt_month.Rows[i].ItemArray[(int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxOP_CD].ToString().Trim();
                string category = dt_month.Rows[i].ItemArray[(int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxCATEGORY].ToString().Trim();
                string round    = dt_month.Rows[i].ItemArray[(int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxNF_CD].ToString().Trim();
                string date     = dt_month.Rows[i].ItemArray[(int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxDATE].ToString().Trim();
                string qty      = dt_month.Rows[i].ItemArray[(int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxQTY].ToString().Trim();
                ...
                if (!check_key.Equals(check_point))
                {
                    ...
                    {
                        if (j <= (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxQTY)
                ...
                for (int j = (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxMAX_CNT; j < fgrid_year.Cols.Count; j++)
                {
        ...
        private void Display_Grid_Day()
        {
            ...
            {
                int lev = int.Parse(dt_day.Rows[i].ItemArray[(int)ClassLib.TBEDM_PCC_PROD_DAY_VJ.IxT_LEV].ToString());
        ...
        private DataTable MakeChartData_Month()
        {
            try
            {
                ...
                {
                    int viStartCol = (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxMAX_CNT;
                    ...
                    {
                        if (fgrid_year[row, (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxOP_CD].ToString().Equals("FGA") &&
                            fgrid_year[row, (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxNF_CD].ToString().Equals(""))
                        {
                            vaTotRow.Add(row);
                            vDTmonth.Columns.Add(fgrid_year[row, (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxITEM].ToString());
                        }
                    }
                    ...
                    for (int col = viStartCol; col < viEndCol; col++)
                    {
                        ...
                        {
                            object x_label = fgrid_year[viTitle1Row, col].ToString() + "/" + int.Parse(fgrid_year[viTitle2Row, col].ToString()).ToString();
                            ...
                            drMonth[fgrid_year[row, (int)ClassLib.TBEDM_PCC_PROD_MONTH_VJ.IxITEM].ToString()] = item;
                        }
        ...
        private DataTable MakeChartData_Daily()
        {
            ...
            {                
                ...
                {
                    int viStartCol = (int)ClassLib.TBEDM_PCC_PROD_DAY_VJ.IxDAY_01;
                    ...
                    for (int col = viStartCol; col < viEndCol; col++)
                    {
                        if (fgrid_month.Cols[col].Visible)
                        {
                            ...
                            object x_label = fgrid_month[viTitle2Row, col].ToString();
                            ...
                            for (int row = fgrid_month.Rows.Fixed; row < fgrid_month.Rows.Count; row++)
                            {
                                ...
                                if (fgrid_month[row, (int)ClassLib.TBEDM_PCC_PROD_DAY_VJ.IxT_LEV].ToString().Equals("1"))
                                {
        ...
        private void cmb_month_SelectedValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int j = (int)ClassLib.TBEDM_PCC_PROD_DAY_VJ.IxDAY_01; j < fgrid_month.Cols.Count; j++)
