...
{
	public class Form_Purchase_Incomming_List : COM.PCHWinForm.Pop_Large_B
	{

		#region 컨크롤 정의 및 리소스 정의
		...
		public Form_Purchase_Incomming_List()
		{
		...
		public Form_Purchase_Incomming_List(Incomming.Form_Incomming_Manager arg_request1)
		{
			// 이 호출은 Windows Form 디자이너에 필요합니다.
			InitializeComponent();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_Purchase_Incomming_List));
            ...
            this.pnl_Top.Controls.Add(this.cmb_PurNo);
            ...
            this.pnl_Top.Controls.Add(this.lbl_PurDate);
            ...
            // lbl_PurNo
            // 
            this.lbl_PurNo.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lbl_PurNo.ImageIndex = 0;
            this.lbl_PurNo.ImageList = this.img_Label;
            this.lbl_PurNo.Location = new System.Drawing.Point(591, 36);
            this.lbl_PurNo.Name = "lbl_PurNo";
            this.lbl_PurNo.Size = new System.Drawing.Size(100, 21);
            this.lbl_PurNo.TabIndex = 272;
            this.lbl_PurNo.Tag = "1";
            this.lbl_PurNo.Text = "No";
            ...
            // lbl_PurDate
            // 
            this.lbl_PurDate.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lbl_PurDate.ImageIndex = 0;
            this.lbl_PurDate.ImageList = this.img_Label;
            this.lbl_PurDate.Location = new System.Drawing.Point(285, 36);
            this.lbl_PurDate.Name = "lbl_PurDate";
            this.lbl_PurDate.Size = new System.Drawing.Size(100, 21);
            this.lbl_PurDate.TabIndex = 267;
            this.lbl_PurDate.Tag = "1";
            this.lbl_PurDate.Text = "Date";
            ...
            this.cmb_PurNo.EditorFont = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.cmb_PurNo.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.cmb_PurNo.Location = new System.Drawing.Point(692, 37);
            ...
            this.cmb_PurNo.Size = new System.Drawing.Size(160, 20);
            this.cmb_PurNo.Style = style16;
            this.cmb_PurNo.TabIndex = 286;
            ...
            this.cmb_Vendor.TabIndex = 287;
            this.cmb_Vendor.PropBag = resources.GetString("cmb_Vendor.PropBag");
            // 
            // Form_Purchase_Incomming_List
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(6, 14);
            this.ClientSize = new System.Drawing.Size(892, 619);
            this.Controls.Add(this.pnl_Body);
            this.Controls.Add(this.pnl_Top);
            this.Name = "Form_Purchase_Incomming_List";
            this.Load += new System.EventHandler(this.Pop_Purchase_List_Load);
		...
		{
			this.Text               = "PCC_Purchase Incomming List";
			this.lbl_MainTitle.Text = "PCC_Purchase Incomming List";
			...
			//Purchase No Setting 
            dt_list = Select_SXP_Pur_Head_Get_Pur_No(cmb_Factory.SelectedValue.ToString(), dtp_Std_Ymd.Text, dtp_Fin_Ymd.Text);
            ClassLib.ComCtl.Set_ComboList_AddItem(dt_list, cmb_PurNo, true, 0, 0, 0, 160);
			...
			fgrid_Main.Tree.Column =  (int)ClassLib.TBSXI_IN_LIST_PUR.IxITEM01;
			#endregion	
		...
		private void Display_Grid()
		{
			...
			DataTable dt_list = Select_SXI_In_List_Pur( cmb_Factory.SelectedValue.ToString(),  dtp_Std_Ymd.Text,  dtp_Fin_Ymd.Text, cmb_PurNo.SelectedValue.ToString(), cmb_Vendor.SelectedValue.ToString(), ClassLib.ComFunction.Empty_TextBox(txt_MatName, "") );
			
			for(int i=0; i < dt_list.Rows.Count; i++)
			{
			
				int tree_level = int.Parse(dt_list.Rows[i].ItemArray[(int)ClassLib.TBSXI_IN_LIST_PUR.IxLEVEL].ToString());
                ...
                fgrid_Main[fgrid_Main.Rows.Count - 1, (int)ClassLib.TBSXI_IN_LIST_PUR.IxY_FLG] = "true";	
		...
		{		
			...
			{
				if(fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_PUR.IxY_FLG].ToString() == "True")
				{

					if(Grid_Add_Check(i) == false )
					{
						if(fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_PUR.IxLEVEL].ToString() == "1")
		...
		{									
			#region Grid Data--> 변수		
			string buf_LEVEL          = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxLEVEL].ToString(); 		
			string buf_BAR_CODE       = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxBAR_CODE].ToString();
		...
		{			
			if(fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxLEVEL].ToString() == "1")
			{			
				#region Grid Data --> 변수 
				//string buf_STATUS		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxSTATUS].ToString();   	      
				string buf_Y_FLG		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxY_FLG].ToString();   	      
				string buf_LEVEL		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxLEVEL].ToString();   	      
				string buf_PUR_NO		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxPUR_NO].ToString(); 
				string buf_PUR_SEQ		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxPUR_SEQ].ToString();
				string buf_PUR_DIV		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxPUR_DIV].ToString();
				string buf_ITEM01		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxITEM01].ToString();   	      
				string buf_ITEM02		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxITEM02].ToString();   	      
				string buf_ITEM03		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxITEM03].ToString();   	      
				string buf_ITEM04		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxITEM04].ToString();			
				string buf_VALUE_PUR	  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxVALUE_PUR].ToString(); 
				string buf_VALUE_IN       = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxVALUE_IN].ToString();
				string buf_VALUE_ADV_IN   = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxVALUE_ADV_IN].ToString(); 
				string buf_PUR_CURRENCY   = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxPUR_CURRENCY].ToString(); 
				string buf_PUR_PRICE      = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxPUR_PRICE].ToString(); 
				string buf_CBD_CURRENCY   = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxCBD_CURRENCY].ToString();
				string buf_CBD_PRICE      = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxCBD_PRICE].ToString(); 
				string buf_BAR_CODE       = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxBAR_CODE].ToString();
				string buf_MRP_REQ_FLG    = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxMRP_REQ_FLG].ToString();
				string buf_PRICE_YN		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxPRICE_YN].ToString();
				string buf_TRANSPORT_TYPE = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxTRANSPORT_TYPE].ToString();				       
				string buf_VENDOR		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxVENDOR_DESC].ToString();			   		     
				string buf_REMARKS		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxREMARKS].ToString();   		   		     
				string buf_UPD_USER		  = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_PUR.IxUPD_USER].ToString();				
				#endregion				
				...
				arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST.IxIN_DIV]         = "01"; 
        ...
        private void cmb_PurNo_SelectedValueChanged(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    //Vendor Setting 
                    DataTable dt_ret = Select_SXP_Pur_Vendor(cmb_Factory.SelectedValue.ToString(), dtp_Std_Ymd.Text, dtp_Fin_Ymd.Text, ClassLib.ComFunction.Empty_Combo(cmb_PurNo, ""));
                    ClassLib.ComCtl.Set_ComboList_AddItem(dt_ret, cmb_Vendor, true, 0, 1, 0, 160);
		...
		{			
			...
			{						
                ...
                {                    
                    ...
                    {
                        if (fgrid_Main[selectRow[i], (int)ClassLib.TBSXI_IN_LIST_PUR.IxBAR_CODE].ToString() != fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_PUR.IxBAR_CODE].ToString())
                            break;
                        if (fgrid_Main[selectRow[i], (int)ClassLib.TBSXI_IN_LIST_PUR.IxY_FLG].ToString() == "True")
                        {
                            fgrid_Main.Update_Row(j);
                            fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_PUR.IxY_FLG] = "True";
                        }
                        else
                        {
                            fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_PUR.IxY_FLG] = "False";
                            fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_PUR.IxDIVISION] = "";
                ...
                //            {						
                //                if(fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_PUR.IxBAR_CODE].ToString() != fgrid_Main[j,(int)ClassLib.TBSXI_IN_LIST_PUR.IxBAR_CODE].ToString()) 
                //                    break;
                ...
                //        if(fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_PUR.IxLEVEL].ToString() == "1")
                //        {
                //            fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_PUR.IxDIVISION] = "";	
        ...
        #region DB Connect
        private DataTable Select_SXP_Pur_Head_Get_Pur_No(string arg_factory, string arg_std_ymd, string arg_fin_ymd )
		{
		
			MyOraDB.ReDim_Parameter(4);

			//01.PROCEDURE명
			MyOraDB.Process_Name ="PKG_SXI_IN_01_SELECT.SELECT_SXP_PUR_HEAD_GET_PUR_NO";
		...
		private DataTable Select_SXP_Pur_Vendor(string arg_factory, string arg_std_ymd, string arg_fin_ymd, string arg_pur_no)
		{
			MyOraDB.ReDim_Parameter(5);

			//01.PROCEDURE명
			MyOraDB.Process_Name = "PKG_SXI_IN_01_SELECT.SELECT_SXP_PUR_VENDOR" ;
			...
			MyOraDB.Parameter_Values[1] = arg_std_ymd;
			MyOraDB.Parameter_Values[2] = arg_fin_ymd;
			MyOraDB.Parameter_Values[3] = arg_pur_no;
		...
		private DataTable Select_SXI_In_List_Pur(string arg_factory, string arg_std_ymd, string arg_fin_ymd, string arg_pur_no, string arg_vendor, string arg_mat_name )
		{
			
			MyOraDB.ReDim_Parameter(7);

			//01.PROCEDURE명
			MyOraDB.Process_Name = "PKG_SXI_IN_01_SELECT.SELECT_SXI_IN_LIST_PUR";
		...
		private void Pop_Purchase_List_Load(object sender, System.EventArgs e)
		{
            try
            {
                this.Cursor = Cursors.WaitCursor;
