...
{
    public partial class Form_SMS_List : COM.PCHWinForm.Form_Top
    {

        #region 생성자
        public Form_SMS_List()
        {
            InitializeComponent();
        }
        ...
        {
            #region Grid setting
            fgrid_main.Set_Grid_CDC("SDK_SMS_SEND", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
        ...
        private DataTable SELECT_USER()
        {
            ...
            MyOraDB.Process_Name = "PKG_SXG_SMS_SELECT.SELECT_USER";
        ...
        private DataTable Select_sms_send(string arg_month_from, string arg_month_to, string arg_dest_name)
        {
            ...
            MyOraDB.Process_Name = "PKG_SXG_SMS_SELECT.SELECT_SMS_SEND";
        ...
        private void tbtn_Print_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
        {
             try
            {
                ...
                string mrd_Filename = Application.StartupPath + @"\SMS_List" + ".mrd";
