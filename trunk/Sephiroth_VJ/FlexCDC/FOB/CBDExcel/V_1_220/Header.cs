...
namespace FlexCDC.FOB.CBDExcel.V_1_220
{
    class Header
    {
        ...
        public bool CheckExcelFile()
        {
            try
            {
                ...
                try
                {
                    ...
                    else if (!factory_value.Equals("JJ") && !factory_value.Equals("QD") && !factory_value.Equals("VJ"))
                    {
                        // DS 입력 불가
                        MessageBox.Show("Sheet Name : " + sheet_name + "\r\n\r\n" + "Primary Production (Factory) Data is worng.");
                        return false;
        ...
        public DataSet ExecuteMacro()
        {
            try
            {
                //worksheet.get_Range(worksheet.Cells[37, 14], worksheet.Cells[1000, 14]).NumberFormat = "0.000000_ ";
