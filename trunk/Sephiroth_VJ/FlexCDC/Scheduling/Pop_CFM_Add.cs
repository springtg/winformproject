...
namespace FlexCDC.Scheduling
{
	public class Pop_CFM_Add : COM.APSWinForm.Pop_Small
	{
		...
		private void Init_Form()
		{
			...
			ClassLib.ComCtl.Set_Factory_List(dt_ret, cmbFactory, 0, 1, false, COM.ComVar.ComboList_Visible.Code_Name);
		...
		{
			Scheduling.Pop_CFM_Select_Style NewStyle = new Scheduling.Pop_CFM_Select_Style(this, vFactory, vSeason, vDPO, vStyleNo);
			NewStyle.ShowDialog();
		}
