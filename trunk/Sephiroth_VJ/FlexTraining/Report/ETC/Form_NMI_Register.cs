...
namespace FlexTraining.ETC
{
	public class Form_NMI_Register : COM.TrainingWinForm.Form_Top
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmb_Line.Location = new System.Drawing.Point(520, 56);
			...
			this.cmb_Line.Size = new System.Drawing.Size(176, 21);
			...
			this.cmb_TD_Code.EditorFont = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.txt_VSM.Location = new System.Drawing.Point(520, 79);
			this.txt_VSM.MaxLength = 20;
			this.txt_VSM.Name = "txt_VSM";
			this.txt_VSM.Size = new System.Drawing.Size(176, 22);
			...
			this.label4.Location = new System.Drawing.Point(416, 77);
			...
			this.txt_Season.Location = new System.Drawing.Point(520, 33);
			this.txt_Season.MaxLength = 20;
			this.txt_Season.Name = "txt_Season";
			this.txt_Season.Size = new System.Drawing.Size(176, 22);
			...
			this.cmb_Style.EditorFont = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.cmb_Style.Location = new System.Drawing.Point(109, 78);
			...
			this.cmb_Style.Size = new System.Drawing.Size(227, 21);
			...
			this.cmb_Style.Click += new System.EventHandler(this.cmb_Style_SelectedValueChanged);
			// 
			// label3
			// 
			...
			this.cmb_OBS_ID.EditorFont = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.cmb_OBS_ID.Size = new System.Drawing.Size(227, 21);
			...
			this.lbl_Month.Location = new System.Drawing.Point(416, 34);
			...
			this.lbl_Acc.Location = new System.Drawing.Point(416, 56);
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "New Model Introduction";
			this.Text		   = "NMI";
		...
		private void setDPO()
		{			
			DataTable dt_ret = Select_DP_DPO_List(cmb_Factory.SelectedValue.ToString(), "3" );
...
//			}
		...
		public DataTable SELECT_NMI_TRACKING(string arg_procedure)
		{
			...
			MyOraDB.Parameter_Name[ 1]  = "ARG_OBS_ID";
			MyOraDB.Parameter_Name[ 2]  = "ARG_STYLE_CD";
			MyOraDB.Parameter_Name[ 3]  = "ARG_D_DATE";
			...
			MyOraDB.Parameter_Values[ 3]   = dpick_D_Day.Value.ToString("yyyyMMdd");
...
//
		...
		private void Check_User_Right()
		{
			...
			if ((iCol == _colPIC1) || (iCol == _colPIC2) || (iCol == _colPIC3) || (iCol == _colPIC4))
			{
				if (sUser.ToUpper() == (fgrid_main[iRow, _colADMIN_USER].ToString()))
				{
					fgrid_main.Rows[iRow].AllowEditing = true;
				}
			}
			else if (iCol == _colACTUAL_DATE || iCol == _colREMARK)
			{
				if ( (sUser.ToUpper()== update_user[0])|| (sUser.ToUpper()== update_user[1]) ||(sUser.ToUpper()== update_user[2])||(sUser.ToUpper()== update_user[3]) )
				{
					fgrid_main.Rows[iRow].AllowEditing = true;
				}
			}
