...
{
	public class Form_Training_GRP : COM.TrainingWinForm.Form_Top
	{
		...
		private System.Windows.Forms.TextBox txt_Training_GRP;
		private C1.Win.C1List.C1Combo cmb_Training_GRP;
		private System.ComponentModel.IContainer components = null;

		public Form_Training_GRP()
		{
		...
		private int _colFACTORY 	 = (int)ClassLib.TBSIM_TRAINING_GRP.IxFACTORY;
		private int _colT_GRP_CODE 	 = (int)ClassLib.TBSIM_TRAINING_GRP.IxT_GRP_CODE;
		private int _colT_GRP_NAME 	 = (int)ClassLib.TBSIM_TRAINING_GRP.IxT_GRP_NAME;
		private int _colREMARK   	 = (int)ClassLib.TBSIM_TRAINING_GRP.IxREMARK;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_Training_GRP));
			this.c1Sizer1 = new C1.Win.C1Sizer.C1Sizer();
			this.panel2 = new System.Windows.Forms.Panel();
			this.fgrid_main = new COM.FSP();
			this.pnl_Search = new System.Windows.Forms.Panel();
			this.pnl_SearchImage = new System.Windows.Forms.Panel();
			this.txt_Training_GRP = new System.Windows.Forms.TextBox();
			this.cmb_Training_GRP = new C1.Win.C1List.C1Combo();
			...
			((System.ComponentModel.ISupportInitialize)(this.cmb_Training_GRP)).BeginInit();
			...
			this.pnl_SearchImage.Controls.Add(this.txt_Training_GRP);
			this.pnl_SearchImage.Controls.Add(this.cmb_Training_GRP);
			...
			// txt_Training_GRP
			// 
			this.txt_Training_GRP.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.txt_Training_GRP.Font = new System.Drawing.Font("Verdana", 8.5F);
			this.txt_Training_GRP.Location = new System.Drawing.Point(109, 64);
			this.txt_Training_GRP.MaxLength = 20;
			this.txt_Training_GRP.Name = "txt_Training_GRP";
			this.txt_Training_GRP.Size = new System.Drawing.Size(200, 21);
			this.txt_Training_GRP.TabIndex = 154;
			this.txt_Training_GRP.Text = "";
			// 
			// cmb_Training_GRP
			// 
			this.cmb_Training_GRP.AddItemCols = 0;
			this.cmb_Training_GRP.AddItemSeparator = ';';
			this.cmb_Training_GRP.AllowRowSizing = C1.Win.C1List.RowSizingEnum.AllRows;
			this.cmb_Training_GRP.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.cmb_Training_GRP.Caption = "";
			this.cmb_Training_GRP.CaptionHeight = 17;
			this.cmb_Training_GRP.CharacterCasing = System.Windows.Forms.CharacterCasing.Normal;
			this.cmb_Training_GRP.ColumnCaptionHeight = 18;
			this.cmb_Training_GRP.ColumnFooterHeight = 18;
			this.cmb_Training_GRP.ComboStyle = C1.Win.C1List.ComboStyleEnum.DropdownList;
			this.cmb_Training_GRP.ContentHeight = 17;
			this.cmb_Training_GRP.DeadAreaBackColor = System.Drawing.Color.Empty;
			this.cmb_Training_GRP.EditorBackColor = System.Drawing.SystemColors.Window;
			this.cmb_Training_GRP.EditorFont = new System.Drawing.Font("Verdana", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.cmb_Training_GRP.EditorForeColor = System.Drawing.SystemColors.WindowText;
			this.cmb_Training_GRP.EditorHeight = 17;
			this.cmb_Training_GRP.Font = new System.Drawing.Font("Verdana", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.cmb_Training_GRP.GapHeight = 2;
			this.cmb_Training_GRP.ItemHeight = 15;
			this.cmb_Training_GRP.Location = new System.Drawing.Point(310, 64);
			this.cmb_Training_GRP.MatchEntryTimeout = ((long)(2000));
			this.cmb_Training_GRP.MaxDropDownItems = ((short)(5));
			this.cmb_Training_GRP.MaxLength = 32767;
			this.cmb_Training_GRP.MouseCursor = System.Windows.Forms.Cursors.Default;
			this.cmb_Training_GRP.Name = "cmb_Training_GRP";
			this.cmb_Training_GRP.PartialRightColumn = false;
			this.cmb_Training_GRP.PropBag = "<?xml version=\"1.0\"?><Blob><Styles type=\"C1.Win.C1List.Design.ContextWrapper\"><Da" +
			...
			this.cmb_Training_GRP.RowDivider.Color = System.Drawing.Color.DarkGray;
			this.cmb_Training_GRP.RowDivider.Style = C1.Win.C1List.LineStyleEnum.None;
			this.cmb_Training_GRP.RowSubDividerColor = System.Drawing.Color.DarkGray;
			this.cmb_Training_GRP.Size = new System.Drawing.Size(250, 21);
			this.cmb_Training_GRP.TabIndex = 153;
			// 
			// cmb_factory
			// 
			...
			this.lbl_Training.Text = "Training Group";
			...
			this.btn_Delete.Location = new System.Drawing.Point(914, 4);
			...
			this.btn_Insert.Location = new System.Drawing.Point(834, 4);
			this.btn_Insert.Name = "btn_Insert";
			this.btn_Insert.Size = new System.Drawing.Size(80, 27);
			...
			this.Name = "Form_Training_GRP";
			this.Load += new System.EventHandler(this.Form_Training_GRP_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.cmb_Training_GRP)).EndInit();
		...
		private void Form_Training_GRP_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		}
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "Training Group";
			this.Text		   = "Training Group";


			// grid set
			fgrid_main.Set_Grid("SIM_TRAINING_GRP", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
		...
		private void Tbtn_SearchProcess()
		{
			try
			{
				...
				string vProcedure     = "PKG_SIM_TRAINING_GRP.SELECT_SIM_TRAINING_GRP";

				DataTable vDt = SELECT_SIM_TRAINING_GRP(vProcedure);
		...
		public DataTable SELECT_SIM_TRAINING_GRP(string arg_procedure)
		{
			DataSet vDt;
			...
			MyOraDB.Parameter_Values[ 1]   = ClassLib.ComFunction.Empty_Combo(cmb_Training_GRP, "");
		...
		private bool Validate_Check()
		{
			...
			{
				if ((fgrid_main[iRow, _colT_GRP_NAME].ToString().Replace(" ", "").Trim().Length == 0) )
				{
					fgrid_main[iRow, 0] = "";					
				}
			}			
		...
		public bool SAVE_SIM_TRAINING_GRP(bool doExecute)
		{
			try
			{
				int save_ct = 0;   
				...
				//01.PROCEDURE NAME
				MyOraDB.Process_Name = "PKG_SIM_TRAINING_GRP.SAVE_SIM_TRAINING_GRP";

				//02.ARGURMENT NAME
				MyOraDB.Parameter_Name[ 0] = "ARG_DIVISION";
				MyOraDB.Parameter_Name[ 1] = "ARG_FACTORY";
				MyOraDB.Parameter_Name[ 2] = "ARG_T_GRP_CODE";
				MyOraDB.Parameter_Name[ 3] = "ARG_T_GRP_NAME";
				MyOraDB.Parameter_Name[ 4] = "ARG_REMARK";
				MyOraDB.Parameter_Name[ 5] = "ARG_UPDATE_USER";
				...
				for (int iRow = fgrid_main.Rows.Fixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					if(fgrid_main[iRow, 0].ToString() != "")
					{
						...
						MyOraDB.Parameter_Values[para_ct+ 2] = fgrid_main[iRow, _colT_GRP_CODE].ToString();
						MyOraDB.Parameter_Values[para_ct+ 3] = fgrid_main[iRow, _colT_GRP_NAME].ToString();
						MyOraDB.Parameter_Values[para_ct+ 4] = ClassLib.ComFunction.Empty_String(fgrid_main[iRow, _colREMARK].ToString(),"");
