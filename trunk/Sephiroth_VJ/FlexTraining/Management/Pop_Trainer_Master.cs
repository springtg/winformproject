...
{
	public class Pop_Trainer_Master : COM.TrainingWinForm.Pop_Large
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_Trainer_Master));
			...
			this.c1Sizer1.GridDefinition = "22:False:True;63.6:False:False;10:False:True;4.4:False:True;\t1:False:True;97.875:" +
				"False:False;1.125:False:False;";
			...
			this.panel2.Size = new System.Drawing.Size(783, 318);
			...
			this.fgrid_main.Size = new System.Drawing.Size(783, 318);
			...
			this.pnl_Menu.Location = new System.Drawing.Point(8, 428);
			this.pnl_Menu.Name = "pnl_Menu";
			this.pnl_Menu.Size = new System.Drawing.Size(783, 50);
			...
			this.btn_Delete.Location = new System.Drawing.Point(696, 13);
			...
			this.btn_Insert.Location = new System.Drawing.Point(615, 13);
			...
			this.Name = "Pop_Trainer_Master";
			this.Load += new System.EventHandler(this.Pop_Trainer_Master_Load);
		...
		private void Pop_Trainer_Master_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		...
		private void fgrid_main_DoubleClick(object sender, System.EventArgs e)
		{
			...
			if ((iRow >= _Rowfixed) && (iCol == _colTRAINER_NAME))
		...
		private void btn_ApplyProcess()
		{
			...
			COM.ComVar.Parameter_PopUp[0] = fgrid_main[iRow, _colTRAINER_ID].ToString();
			COM.ComVar.Parameter_PopUp[1] = fgrid_main[iRow, _colTRAINER_NAME].ToString();
			this.Dispose();			
		}
