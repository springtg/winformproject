...
{
	public class Form_SVM_VOC_Material_Process_Report : COM.TrainingWinForm.Form_Top
	{
		...
		private System.Windows.Forms.DateTimePicker dpick_Out_Date_To;
		...
		public Form_SVM_VOC_Material_Process_Report()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_SVM_VOC_Material_Process_Report));
			...
			this.dpick_Out_Date_To = new System.Windows.Forms.DateTimePicker();
			...
			this.fgrid_main.Styles = new C1.Win.C1FlexGrid.CellStyleCollection(@"Normal{Font:Verdana, 9pt;}	Fixed{BackColor:Control;ForeColor:ControlText;Border:Flat,1,ControlDark,Both;}	Highlight{BackColor:Highlight;ForeColor:HighlightText;}	Search{BackColor:Highlight;ForeColor:HighlightText;}	Frozen{BackColor:Beige;}	EmptyArea{BackColor:AppWorkspace;Border:Flat,1,ControlDarkDark,Both;}	GrandTotal{BackColor:255, 192, 255;ForeColor:Blue;}	Subtotal0{BackColor:192, 255, 255;ForeColor:Lime;}	Subtotal1{BackColor:ControlDarkDark;ForeColor:White;}	Subtotal2{BackColor:ControlDarkDark;ForeColor:White;}	Subtotal3{BackColor:ControlDarkDark;ForeColor:White;}	Subtotal4{BackColor:ControlDarkDark;ForeColor:White;}	Subtotal5{BackColor:ControlDarkDark;ForeColor:White;}	");
			...
			this.panel3.Controls.Add(this.dpick_Out_Date_To);
			...
			// dpick_Out_Date_To
			// 
			this.dpick_Out_Date_To.CustomFormat = "";
			this.dpick_Out_Date_To.Font = new System.Drawing.Font("Verdana", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.dpick_Out_Date_To.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			this.dpick_Out_Date_To.Location = new System.Drawing.Point(656, 32);
			this.dpick_Out_Date_To.Name = "dpick_Out_Date_To";
			this.dpick_Out_Date_To.Size = new System.Drawing.Size(107, 22);
			this.dpick_Out_Date_To.TabIndex = 609;
			// 
			// txt_Item_CD
			// 
			...
			// 
			// Form_SVM_VOC_Material_Process_Report
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.c1Sizer1);
			this.Name = "Form_SVM_VOC_Material_Process_Report";
			this.Load += new System.EventHandler(this.Form_SVM_VOC_Material_Process_Report_Load);
		...
		private void Form_SVM_VOC_Material_Process_Report_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		}
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "VOC Material Tracking By Process";
			this.Text		   = "VOC Material Tracking By Process";
			fgrid_main.Set_Grid("SVM_VOC_MAT_REP", "2", 1, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
			...
			//			fgrid_main.Cols[8].Format = "###,###,##0.########";
			//			fgrid_main.Cols[9].Format = "###,###,##0.########";
			//			fgrid_main.Cols[10].Format = "###,###,##0.########";
		...
		private void Tbtn_SearchProcess()
		{
			try
			{
				string vProcedure   = "PKG_SVM_VOC_TRACKING.SELECT_SVM_VOC_PROCESS";
		...
		public DataTable SELECT_SVM_VOC_TRACKING(string arg_procedure)
		{
			...
			//02.ARGURMENT NAME
			MyOraDB.Parameter_Name[ 0]  = "ARG_FACTORY";
			MyOraDB.Parameter_Name[ 1]  = "ARG_PROD_FR_YMD";
			MyOraDB.Parameter_Name[ 2]  = "ARG_PROD_TO_YMD";
			...
			MyOraDB.Parameter_Values[ 2]   = dpick_Out_Date_To.Value.ToString("yyyyMMdd");
			MyOraDB.Parameter_Values[ 3]   = ClassLib.ComFunction.Empty_Combo(cmb_Line, "");
			MyOraDB.Parameter_Values[ 4]   = ClassLib.ComFunction.Empty_Combo(cmb_Item, "");
		...
		private void SubTotalGrid()
		{
			...
			//			fgrid_main.Subtotal(AggregateEnum.Sum,-2, 0, 7, "GTotal");
			fgrid_main.Subtotal(AggregateEnum.Sum,-2, 0, 9, "GTotal");
			fgrid_main.Subtotal(AggregateEnum.Sum,-2, 0, 10, "GTotal");
			fgrid_main.Subtotal(AggregateEnum.Sum,-2, 0, 11, "GTotal");
				
			//			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 4, 7, "STotal0");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 2, 9, "STotal0");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 2, 10, "STotal0");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 2, 11, "STotal0");			 

			//			fgrid_main.Subtotal(AggregateEnum.Sum, 0, 1, 7, "STotal1");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 0, 1, 9, "STotal1");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 0, 1, 10, "STotal1");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 0, 1, 11, "STotal1");			 
		...
		private void PRINT_SVM_VOC_MAT_TRACK_REP()
		{
			string sDir;
			
			sDir = FlexTraining.ClassLib.ComFunction.Set_RD_Directory("Form_SVM_VOC_MAT_TRACK_BY_PROCESS");
			...
			sPara += "'" + dpick_Out_Date_To.Value.ToString("yyyyMMdd") +	"' ";		  //Parm2: Out Date_To
			...
			MyReport.Text = "VOC Material Tracking Report";
			MyReport.Show();
