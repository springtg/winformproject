...
{
	public class Form_Nosew_NMI_Register : COM.TrainingWinForm.Form_Top
	{
		...
		public Form_Nosew_NMI_Register()
		{
		...
		private void InitializeComponent()
		{
			...
			this.Load += new System.EventHandler(this.Form_Nosew_NMI_Register_Load);
		...
		private void Form_Nosew_NMI_Register_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		}
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "No-sew New Product Introduction";
			this.Text		   = "NPI";
...
//				}
		...
		private void Tbtn_SearchProcess()
		{
			try
			{
				...
				string vProcedure     = "PKG_SIV_NMI_TRACKING.SELECT_NOSEW_NMI_TRACKING";
