...
{
	public class Form_SVM_VOC_Material_Tracking_Report : COM.TrainingWinForm.Form_Top
	{
		...
		public Form_SVM_VOC_Material_Tracking_Report()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_SVM_VOC_Material_Tracking_Report));
			...
			// 
			// Form_SVM_VOC_Material_Tracking_Report
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.c1Sizer1);
			this.Name = "Form_SVM_VOC_Material_Tracking_Report";
			this.Load += new System.EventHandler(this.Form_SVM_VOC_Material_Tracking_Report_Load);
		...
		private void Form_SVM_VOC_Material_Tracking_Report_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		}
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "VOC Material Tracking Report";
			this.Text		   = "VOC Material Tracking Report";
			fgrid_main.Set_Grid("SVM_VOC_MAT_REP", "1", 1, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
...
//			//=========== Set Combobox: Begin =================================
		...
		private void PRINT_SVM_VOC_MAT_TRACK_REP()
		{
			...
			sDir = FlexTraining.ClassLib.ComFunction.Set_RD_Directory("Form_SVM_VOC_MAT_TRACK_BY_DATE");
		...
		private void Tbtn_SearchProcess()
		{
			try
			{
				string vProcedure   = "PKG_SVM_VOC_TRACKING.SELECT_SVM_VOC_DATE_REPORT";
...
//			fgrid_main.Subtotal(AggregateEnum.Sum,-2, 0, 7, "GTotal");
			fgrid_main.Subtotal(AggregateEnum.Sum,-2, 0, 8, "GTotal");
...
//			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 4, 7, "STotal0");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 4, 8, "STotal0");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 4, 9, "STotal0");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 1, 4, 10, "STotal0");			 

//			fgrid_main.Subtotal(AggregateEnum.Sum, 0, 1, 7, "STotal1");			 
			fgrid_main.Subtotal(AggregateEnum.Sum, 0, 1, 8, "STotal1");			 
