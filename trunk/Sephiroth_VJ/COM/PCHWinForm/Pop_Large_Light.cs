...
namespace COM.PCHWinForm
{
	...
	/// Form1에 대한 요약 설명입니다.
	/// </summary>
	public class Pop_Large_Light : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_Large_Light));
			...
			this.Name = "Pop_Large_Light";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pop_Large_Light";
			this.Load += new System.EventHandler(this.Pop_Large_Light_Load);
			this.Closed += new System.EventHandler(this.Pop_Large_Light_Closed); 
...
//            COM.ComFunction.Save_SPC_MENU_BOOKMARK(factory, lang_cd, user_id, menu_pg);
		...
		private void Pop_Large_Light_Load(object sender, System.EventArgs e)
		{
			try
			{
		...
		private void Pop_Large_Light_Closed(object sender, System.EventArgs e)
		{
			string menu_pg = this.GetType().ToString();
