...
namespace COM.PCHWinForm
{
	...
	/// Form1에 대한 요약 설명입니다.
	/// </summary>
	public class Pop_Large_B : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_Large_B));
			...
			this.Name = "Pop_Large_B";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Pop_Large_B";
			this.Load += new System.EventHandler(this.Pop_Large_B_Load);
			this.Closed += new System.EventHandler(this.Pop_Large_B_Closed);
...
//            COM.ComFunction.Save_SPC_MENU_BOOKMARK(factory, lang_cd, user_id, menu_pg);
		...
		private void Pop_Large_B_Load(object sender, System.EventArgs e)
		{
			try
			{ 
                ...
                DataTable dt_ret = COM.ComFunction.SELECT_SCM_MENU_USER_TBTN(factory, lang_cd, user_id, menu_pg);
		...
		private void Pop_Large_B_Closed(object sender, System.EventArgs e)
		{
			string menu_pg = this.GetType().ToString();
