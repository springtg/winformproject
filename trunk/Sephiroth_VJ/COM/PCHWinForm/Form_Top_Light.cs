...
namespace COM.PCHWinForm
{
	...
	/// Form1에 대한 요약 설명입니다.
	/// </summary>
	public class Form_Top_Light : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_Top_Light));
			...
			this.Name = "Form_Top_Light";
			this.Text = "Form_Top_Light";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.Form_Top_Light_Load);
			this.Closed += new System.EventHandler(this.Form_Top_Light_Closed);
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void Form_Top_Light_Load(object sender, System.EventArgs e)
		{
			try
			{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void Form_Top_Light_Closed(object sender, System.EventArgs e)
		{
