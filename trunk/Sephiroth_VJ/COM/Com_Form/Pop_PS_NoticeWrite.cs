...
{
	public class Pop_PS_NoticeWrite : APSWinForm.Pop_Large
	{
...
//		}
		...
		private void InitializeComponent()
		{
			...
			this.txt_message.Location = new System.Drawing.Point(8, 112);
			this.txt_message.Multiline = true;
			this.txt_message.Name = "txt_message";
			this.txt_message.Size = new System.Drawing.Size(680, 296);
			...
			this.txt_user_name.Location = new System.Drawing.Point(445, 40);
			...
			this.lbl_user_name.Location = new System.Drawing.Point(344, 40);
			...
			this.txt_user_id.Location = new System.Drawing.Point(109, 40);
			...
			this.lbl_user_id.Location = new System.Drawing.Point(8, 40);
			...
			this.txt_title.Location = new System.Drawing.Point(109, 62);
			...
			this.lbl_show.Location = new System.Drawing.Point(344, 84);
			...
			this.dpick_end.Location = new System.Drawing.Point(218, 84);
			this.dpick_end.Name = "dpick_end";
			this.dpick_end.Size = new System.Drawing.Size(89, 21);
			...
			this.dpick_Start.Location = new System.Drawing.Point(109, 84);
			this.dpick_Start.Name = "dpick_Start";
			this.dpick_Start.Size = new System.Drawing.Size(89, 21);
			...
			this.chk_show.Location = new System.Drawing.Point(444, 84);
			this.chk_show.Name = "chk_show";
			this.chk_show.Size = new System.Drawing.Size(21, 21);
			...
			this.Controls.Add(this.dpick_end);
			...
			this.Controls.SetChildIndex(this.lbl_user_id, 0);
			this.Controls.SetChildIndex(this.txt_user_id, 0);
			this.Controls.SetChildIndex(this.lbl_user_name, 0);
			this.Controls.SetChildIndex(this.txt_user_name, 0);
			this.Controls.SetChildIndex(this.lbl_title, 0);
			this.Controls.SetChildIndex(this.txt_title, 0);
			this.Controls.SetChildIndex(this.chk_show, 0);
			this.Controls.SetChildIndex(this.lbl_date, 0);
			this.Controls.SetChildIndex(this.dpick_Start, 0);
			this.Controls.SetChildIndex(this.dpick_end, 0);
			this.Controls.SetChildIndex(this.lbl_show, 0);
		...
		{ 
			...
			dpick_Start.CustomFormat = ComVar.This_SetedDateType;
			dpick_end.CustomFormat = ComVar.This_SetedDateType;

			dpick_Start.Value = DateTime.Now;
			dpick_end.Value = DateTime.Now.AddDays(7);

			//ComFunction.Get_Values(this, dpick_Start.Name, dpick_end.Name);

			string arg_user_id = ComVar.This_User;
			string arg_user_name;

			DataTable dt = GetUserName(arg_user_id);

			string name1 = dt.Rows[0].ItemArray[0].ToString();
			string name2 = dt.Rows[0].ItemArray[1].ToString();
			...
			txt_user_id.Text   = arg_user_id;
			txt_user_name.Text = arg_user_name;
...
//			dpick_end.Value   = DateTime.Now.AddDays(7);	
		...
		private void btn_save_Click(object sender, System.EventArgs e)
		{
			...
			ComFunction.Data_Message(ComVar.MgsEndSave);
			Close();
		}
		...
		{
			ComFunction.Set_Values(this, dpick_Start.Name, dpick_end.Name);
		}
