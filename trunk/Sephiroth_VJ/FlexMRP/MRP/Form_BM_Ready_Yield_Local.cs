...
namespace FlexMRP.MRP
{
	...
	public class Form_BM_Ready_Yield_Local : COM.PCHWinForm.Form_Top
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_BM_Ready_Yield_Local));
			...
			this.lbl_MainTitle.Text = "Local/LLT Yield Check";
			// 
			// tbtn_Print
			// 
