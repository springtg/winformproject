...
{
	public class Form_BM_MRP_Monitoring_Style : COM.PCHWinForm.Form_Top
	{
		#region 윈폼 멤버
		...
		private Pop_BM_Shipping_Wait _waitPop = null;
		...
		public Form_BM_MRP_Monitoring_Style()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_BM_MRP_Monitoring_Style));
			...
			this.btn_mrpDS.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(239)), ((System.Byte)(248)), ((System.Byte)(251)));
			...
			this.btn_shipping.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(239)), ((System.Byte)(248)), ((System.Byte)(251)));
			...
			this.btn_all.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(239)), ((System.Byte)(248)), ((System.Byte)(251)));
			...
			// lbl_shipFactory
			// 
			this.lbl_shipFactory.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(239)), ((System.Byte)(248)), ((System.Byte)(251)));
			this.lbl_shipFactory.Font = new System.Drawing.Font("굴림", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// 
			// Form_BM_MRP_Monitoring_Style
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.c1Sizer1);
			this.Name = "Form_BM_MRP_Monitoring_Style";
		...
		private void cmb_shipType_SelectedValueChanged(object sender, System.EventArgs e)
		{
			...
			{
				spd_main.Set_Spread_Comm("SBM_MRP_MONITORING_STYLE", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, true);
			}
			else
			{
				spd_main.Set_Spread_Comm("SBM_MRP_MONITORING_STYLE", "2", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, true);
			}
		...
		private void btn_mrpDS_Click(object sender, System.EventArgs e)
		{
			...
			{
				_cols = new int[]{ (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_SHIPPING_SCHEDULE,
									 (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_MRP_RECEIVE,
									 (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_MRP_MODIFY };
		...
		private void btn_purchase_Click(object sender, System.EventArgs e)
		{
			if (this.Validate_Check(_validate_BtnClick))
			{
				_cols = new int[]{ (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_PURCHASE_MANAGER,
									 (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_PURCHASE_ORDER_RECEIVE,
									 (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_PURCHASE_ORDER_MODIFY };
		...
		private void btn_shipping_Click(object sender, System.EventArgs e)
		{
			if (this.Validate_Check(_validate_BtnClick))
			{
				_cols = new int[]{ (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_SHIPPING_LIST_CREATE,
									 (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_SHIPPING_LIST_MODIFY,
									 (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxDS_BAR_CODE };
		...
		private void Init_Form()
		{
			try
			{
				this.Text = "MRP Monitoring By Style";
				lbl_MainTitle.Text = "MRP Monitoring By Style";
		...
		private void Init_HeaderFactory()
		{
			...
			int vCol1 = (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxMRP_RUN;
			int vCol2 = (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxMRP_MODIFY;
			int vCol3 = (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxMRP_SEND;
		...
		private void Search_Data()
		{
			try
			{
				...
				_waitPop = new Pop_BM_Shipping_Wait();
		...
		private void Get_AfterMRPData()
		{
			...
			{
				ClassLib.ComFunction.User_Message(ex.Message, "ETC Data Loading", MessageBoxButtons.OK, MessageBoxIcon.Warning);
			}
			finally
			{
				ClassLib.ComFunction.Change_WebService_URL(COM.ComVar.This_Factory); 
		...
		/// <summary>
		/// PKG_SBM_MRP_MONITORING.SELECT_MRP_DATA : 해외 MRP 데이터 가져오기
		/// </summary>
		...
		public DataTable SELECT_MRP_DATA()
		{
			try
			{
				...
				//01.PROCEDURE명
				MyOraDB.Process_Name = "PKG_SBM_MRP_MONITORING.SELECT_MRP_DATA";
		...
		/// <summary>
		/// PKG_SBM_MRP_MONITORING.SELECT_AFTER_MRP_DATA : 한국 MRP 데이터 검색하기
		/// </summary>
		/// <returns>DataTable</returns>
		public DataTable SELECT_AFTER_MRP_DATA(int arg_row, string arg_division)
		{
			...
			//01.PROCEDURE명
			MyOraDB.Process_Name = "PKG_SBM_MRP_MONITORING.SELECT_AFTER_MRP_DATA";
			...
			MyOraDB.Parameter_Values[2] = ClassLib.ComFunction.NullToBlank(_mainSheet.Cells[arg_row, (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxFACTORY].Value);
			MyOraDB.Parameter_Values[3] = ClassLib.ComFunction.NullToBlank(_mainSheet.Cells[arg_row, (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxSHIP_TYPE].Value);
			MyOraDB.Parameter_Values[4] = ClassLib.ComFunction.NullToBlank(_mainSheet.Cells[arg_row, (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxMRP_SHIP_NO].Value);
			MyOraDB.Parameter_Values[5] = ClassLib.ComFunction.NullToBlank(_mainSheet.Cells[arg_row, (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxOBS_TYPE].Value);
			MyOraDB.Parameter_Values[6] = ClassLib.ComFunction.NullToBlank(_mainSheet.Cells[arg_row, (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxLOT_NO].Value);
			MyOraDB.Parameter_Values[7] = ClassLib.ComFunction.NullToBlank(_mainSheet.Cells[arg_row, (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxLOT_SEQ].Value);
			MyOraDB.Parameter_Values[8] = ClassLib.ComFunction.NullToBlank(_mainSheet.Cells[arg_row, (int)ClassLib.TBSBM_MRP_MONITORING_STYLE.IxSTYLE_CD].Value);
