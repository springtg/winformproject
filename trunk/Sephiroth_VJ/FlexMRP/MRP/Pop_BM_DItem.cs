...
namespace FlexMRP.MRP
{
	...
	/// </summary>
	public class Pop_BM_DItem : System.Windows.Forms.UserControl
	{
		...
		public Pop_BM_DItem(string arg_default_date)
		{
			// 이 호출은 Windows.Forms Form 디자이너에 필요합니다.
			InitializeComponent();
			...
			// TODO: InitializeComponent를 호출한 다음 초기화 작업을 추가합니다.
			lbl_item.Text = "Date";
			dpick_value.Text = arg_default_date;
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_BM_DItem));
