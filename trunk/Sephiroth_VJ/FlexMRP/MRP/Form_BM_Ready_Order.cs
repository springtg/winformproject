...
{
	public class Form_BM_Ready_Order : COM.PCHWinForm.Form_Top, IOperation
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_BM_Ready_Order));
			...
			this.Name = "Form_BM_Ready_Order";
			this.Text = "Form_BM_Ready_Order";
		...
		{						
			...
			lbl_MainTitle.Text = "Order Check";
		...
		private void  SetPrintYield()
		{
			...
			{   
				...
				aHead[1]    = dpick_from.Text.Replace("-", "").Remove(0, 2);
				aHead[2]    = dpick_to.Text.Replace("-", "").Remove(0, 2);			
		...
		public DataTable SELECT_SBM_ORDER()
		{
			...
			//01.PROCEDURE명
			MyOraDB.Process_Name = "PKG_SBM_READY.SELECT_SBM_ORDER";

			//02.ARGURMENT 명
			MyOraDB.Parameter_Name[0] = "ARG_FACTORY";
			MyOraDB.Parameter_Name[1] = "ARG_OBS_TYPE";
			MyOraDB.Parameter_Name[2] = "ARG_OBS_FROM";
			MyOraDB.Parameter_Name[3] = "ARG_OBS_TO";
			...
			MyOraDB.Parameter_Values[2] = dpick_from.Text.Replace("-", "").Remove(0, 2);
			MyOraDB.Parameter_Values[3] = dpick_to.Text.Replace("-", "").Remove(0, 2);
