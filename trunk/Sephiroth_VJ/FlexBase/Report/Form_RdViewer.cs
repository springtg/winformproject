...
namespace FlexBase.Report
{
	...
	public class Form_RdViewer : System.Windows.Forms.Form
	{
		...
		private void Form_RdViewer_Load(object sender, System.EventArgs e)
		{
			...
			if (mrd_FileName.IndexOf("Form_BP_Purchase_Order_Standend_Tail") != -1)

			{
				...
				this.axRdviewer401.DisableToolbar(13); 
				this.axRdviewer401.DisableToolbar(14);
				this.axRdviewer401.DisableToolbar(16); 
				this.axRdviewer401.DisableToolbar(17);			
			}

			this.axRdviewer401.FileOpen(@mrd_FileName, sParam); 
//			axRdviewer402.FileOpen(@mrd_FileName, sParam); 		
		}
