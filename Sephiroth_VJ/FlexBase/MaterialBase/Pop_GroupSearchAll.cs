...
{
	public class Pop_GroupSearchAll : COM.PCHWinForm.Pop_Small
	{
		...
		public Pop_GroupSearchAll(string arg_group_type)
		{
			// 이 호출은 Windows Form 디자이너에 필요합니다.
			InitializeComponent();
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pop_GroupSearchAll));
            ...
            this.lbl_MainTitle.Size = new System.Drawing.Size(365, 22);
            // 
            // image_List
            // 
            ...
            this.Name = "Pop_GroupSearchAll";
            this.Closing += new System.ComponentModel.CancelEventHandler(this.Pop_GroupSearchAll_Closing);
		...
		private void Select_Menu_List()
		{
			...
			{
				fgrid_GroupTree.Rows.InsertNode(i + _Rowfixed,int.Parse(dt_ret.Rows[i].ItemArray[(int)ClassLib.TBSBC_ITEM_GROUP.IxGROUP_LEVEL-1].ToString()) - 1 );
		...
		private void Pop_GroupSearchAll_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
...
//				DataTable dt_ret;
				...
				string vGroupCd  = fgrid_GroupTree[sel_row, (int)ClassLib.TBSBC_ITEM_GROUP.IxGROUP_CD].ToString();
				...
				_GroupName = fgrid_GroupTree[sel_row, (int)ClassLib.TBSBC_ITEM_GROUP.IxGROUP_NAME].ToString(); 
...
//				{
					_GroupL = fgrid_GroupTree[sel_row, (int)ClassLib.TBSBC_ITEM_GROUP.IxGROUP_L].ToString();
					_GroupM = fgrid_GroupTree[sel_row, (int)ClassLib.TBSBC_ITEM_GROUP.IxGROUP_M].ToString(); 
