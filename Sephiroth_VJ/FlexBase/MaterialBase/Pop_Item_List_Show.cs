...
{
	public class Pop_Item_List_Show : COM.PCHWinForm.Pop_Normal_Light
	{
		...
		public Pop_Item_List_Show(bool arg_bi_incoming_item_change_mode, string arg_item_code, string arg_item_name, string arg_spec_code, string arg_spec_name, string arg_color_code, string arg_color_name)
		{
			// 이 호출은 Windows Form 디자이너에 필요합니다.
			InitializeComponent();
		...
		public System.Windows.Forms.Form _ThisForm = null;
		...
		public Pop_Item_List_Show(string arg_itemcd, 
			string arg_itemname, 
			string arg_speccd, 
			string arg_specname, 
			string arg_colorcd, 
		...
		public Pop_Item_List_Show(System.Windows.Forms.Form arg_form,  string arg_itemcd, 
			string arg_itemname, 
			string arg_speccd, 
			string arg_specname, 
			string arg_colorcd, 
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pop_Item_List_Show));
            ...
            this.Name = "Pop_Item_List_Show";
            this.Closing += new System.ComponentModel.CancelEventHandler(this.Pop_Item_List_Show_Closing);
...
//				}
		...
		private void Pop_Item_List_Show_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			try
			{
			...
			{
				ClassLib.ComFunction.User_Message(ex.Message, "Pop_Item_List_Show_Closing", MessageBoxButtons.OK, MessageBoxIcon.Error);
			} 
		}
