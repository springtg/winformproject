...
namespace FlexBase.MaterialBase
{
	public class Pop_BC_Yield_Info : COM.PCHWinForm.Pop_Medium
	{
		...
		public ArrayList _duplicate = new ArrayList();
		...
		private void InitializeComponent()
		{
            ...
            this.fgrid_yield.Location = new System.Drawing.Point(8, 72);
            this.fgrid_yield.Name = "fgrid_yield";
            this.fgrid_yield.Size = new System.Drawing.Size(678, 309);
            ...
            this.groupBox2.Size = new System.Drawing.Size(678, 69);
            ...
            this.btn_search.Location = new System.Drawing.Point(330, 40);
            this.btn_search.Name = "btn_search";
            this.btn_search.Size = new System.Drawing.Size(21, 21);
            this.btn_search.TabIndex = 544;
            ...
            this.cmb_style_cd.CaptionStyle = style17;
            ...
            this.cmb_style_cd.EvenRowStyle = style18;
            ...
            this.cmb_style_cd.FooterStyle = style19;
            this.cmb_style_cd.GapHeight = 2;
            this.cmb_style_cd.HeadingStyle = style20;
            this.cmb_style_cd.HighLightRowStyle = style21;
            this.cmb_style_cd.ItemHeight = 15;
            this.cmb_style_cd.Location = new System.Drawing.Point(189, 40);
            ...
            this.cmb_style_cd.OddRowStyle = style22;
            ...
            this.cmb_style_cd.SelectedStyle = style23;
            this.cmb_style_cd.Size = new System.Drawing.Size(140, 21);
            this.cmb_style_cd.Style = style24;
            ...
            this.rad_All.Location = new System.Drawing.Point(136, 23);
            ...
            this.rad_Comp.Location = new System.Drawing.Point(73, 23);
            ...
            this.rad_SG.Location = new System.Drawing.Point(16, 23);
            ...
            this.txt_style_cd.Size = new System.Drawing.Size(79, 21);
				...
				for (int vRow = fgrid_yield.Rows.Fixed ; vRow < fgrid_yield.Rows.Count ; vRow++)
				{
					if ( (bool)fgrid_yield[vRow, _chkApplyCol] )
					{
						...
						else
						{
							...
							else if (_mode.Equals("M")) // MRP 전용
								vFlag = Etc_DataDuplicateCheck_MRP(vRow);
							else
		...
		private int Etc_DataDuplicateCheck_MRP(int arg_row)
		{
			int vReturn = 0;

			string[] vData = new string[]{ClassLib.ComVar.Parameter_PopUp[0],
											 ClassLib.ComVar.Parameter_PopUp[2],
											 ClassLib.ComVar.Parameter_PopUp[3],
											 ClassLib.ComVar.Parameter_PopUp[4],
											 ClassLib.ComVar.Parameter_PopUp[5],
											 cmb_style_cd.SelectedValue.ToString(),
											 fgrid_yield[arg_row, _itemCdCol].ToString(),
											 fgrid_yield[arg_row, _specCdCol].ToString(),
											 fgrid_yield[arg_row, _colorCdCol].ToString()};
		...
		private void Select_Yield_List()
		{
			try
			{
				...
				dt_ret = Select_YieldList(vFactory, vStyleCode, vFlag);
				...
				if (dt_ret.Rows.Count > 0)
				{
					...
					for(int i = 0, idx = 0 ; i < dt_ret.Rows.Count ; i++)
					{
						...
						fgrid_yield.Rows.InsertNode(vRow, Convert.ToInt32(dt_ret.Rows[i].ItemArray[0]));
						Grid_InsertData(vRow, dt_ret.Rows[i].ItemArray);
						//fgrid_yield.Rows[vRow].AllowEditing = (bool)fgrid_yield[vRow, _checkYnCol];
						
						/***************************** 아이콘 표시 *********************************/
						
						switch ( fgrid_yield[vRow, _level1Col].ToString() )
						{
