	...
	public class Pop_CreateCmpCd : COM.APSWinForm.Pop_Large
	{
		...
		{ 
			...
			try
			{
				...
				fgrid_Cmp.Set_Grid("SDB_P_CMP", "1", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, true); 
		...
		private void btn_Apply_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				MyOraDB.Save_FlexGird("PKG_SXB_P_RSC.SAVE_SXB_PJ_CMP", fgrid_Cmp); 
		...
		private DataTable Select_SPB_CMP()
		{
			...
			try
			{ 
				string process_name = "PKG_SXB_P_RSC.SELECT_CMP_LIST";
