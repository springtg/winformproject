...
namespace FlexCDC.Incoming_VJ
{

	
	public class Form_Barcode_Scan_List_VJ : COM.PCHWinForm.Pop_Large_B
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_Barcode_Scan_List_VJ));
        ...
        public Incoming_VJ.Form_Incomming_Manager_VJ arg_request = null;  
		#endregion

        #region Resource
        public Form_Barcode_Scan_List_VJ()
        {
        ...
        public Form_Barcode_Scan_List_VJ(Incoming_VJ.Form_Incomming_Manager_VJ arg_request1)
        {
            // 이 호출은 Windows Form 디자이너에 필요합니다.
            InitializeComponent();
        ...
        {
            this.Text = "PCC_Barcode Scan List";
            this.lbl_MainTitle.Text = "PCC_Barcode Scan List";
            ...
            arg_value[3] = ClassLib.ComFunction.Empty_TextBox(txt_Barcode, "");
            
            DataTable dt_ret = SELECT_SXS_BAR_VENDOR(arg_value);
            ...
            #region Grid Setting
            fgrid_Main.Set_Grid_CDC("SXI_IN_LIST_POP_VJ", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, false);
            fgrid_Main.Set_Action_Image(img_Action);
            fgrid_Main.Font = new Font("Verdana", 8);
            fgrid_Main.Tree.Column = (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxITEM01;
            #endregion
        ...
        private DataTable SELECT_SXS_BAR_VENDOR(string [] arg_value)
        {
        ...
        private void Display_Grid()
        {
            ...
            arg_value[1] = dtp_Std_Ymd.Value.ToString("yyyyMMdd");
            arg_value[2] = dtp_Fin_Ymd.Value.ToString("yyyyMMdd");
            arg_value[3] = txt_Barcode.Text.Trim();
            arg_value[4] = cmb_Vendor.SelectedValue.ToString();
            arg_value[5] = txt_MatName.Text.Trim();

            DataTable dt_list = SELECT_SXI_IN_LIST_BAR(arg_value);

            for (int i = 0; i < dt_list.Rows.Count; i++)
            {
                int tree_level = int.Parse(dt_list.Rows[i].ItemArray[(int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxLEVEL].ToString());
                ...
                fgrid_Main[fgrid_Main.Rows.Count - 1, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxY_FLG] = "true";
            }

            fgrid_Main.Tree.Show(1);
        }

        private DataTable SELECT_SXI_IN_LIST_BAR(string [] arg_value)
        {
        ...
        private void Save_Data()
        {
            ...
            {
                if (fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxY_FLG].ToString() == "True")
                {
                    if (Grid_Add_Check(i) == false)
                    {
                        if (fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxLEVEL].ToString() == "1")
            ...
            #region Scan List Grid Data --> Incomming Manager Grid
        ...
        private bool Grid_Add_Check(int arg_rowcount)
        {
            #region Grid Data
            string buf_LEVEL    = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxLEVEL].ToString();
            string buf_BAR_CODE = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxBAR_CODE].ToString();
            #endregion

            #region Same Barcode Check
            for (int i = 0; i < arg_request.fgrid_Main.Rows.Count - 1; i++)
            {
                if (arg_request.fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString() == buf_LEVEL &&
                    arg_request.fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxBAR_CODE].ToString() == buf_BAR_CODE)
                {
                    return false;
                }
            }
        ...
        {
            if (fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxLEVEL].ToString() == "1")
            {
                #region Grid Data --> Variable
                string buf_Y_FLG          = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxY_FLG].ToString();
                string buf_LEVEL          = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxLEVEL].ToString();
                string buf_PUR_NO         = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxPUR_NO].ToString();
                string buf_PUR_SEQ        = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxPUR_SEQ].ToString();
                string buf_PUR_DIV        = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxPUR_DIV].ToString();
                string buf_ITEM01         = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxITEM01].ToString();
                string buf_ITEM02         = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxITEM02].ToString();
                string buf_ITEM03         = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxITEM03].ToString();
                string buf_ITEM04         = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxITEM04].ToString();
                string buf_VALUE_PUR      = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxVALUE_PUR].ToString();
                string buf_VALUE_IN       = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxVALUE_IN].ToString();
                string buf_VALUE_ADV_IN   = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxVALUE_ADV_IN].ToString();
                string buf_PUR_CURRENCY   = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxPUR_CURRENCY].ToString();
                string buf_PUR_PRICE      = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxPUR_PRICE].ToString();
                string buf_CBD_CURRENCY   = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxCBD_PRICE].ToString();
                string buf_CBD_PRICE      = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxCBD_PRICE].ToString();
                string buf_BAR_CODE       = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxBAR_CODE].ToString();
                string buf_MRP_REQ_FLG    = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxMRP_REQ_FLG].ToString();
                string buf_PRICE_YN       = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxPRICE_YN].ToString();
                string buf_TRANSPORT_TYPE = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxTRANSPORT_TYPE].ToString();
                string buf_VENDOR         = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxVENDOR_DESC].ToString();
                string buf_REMARKS        = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxREMARKS].ToString();
                string buf_UPD_USER       = fgrid_Main[arg_rowcount, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxUPD_USER].ToString();
                #endregion
                ...
                #region Variable --> Incomming Manager Grid
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDIVISION]       = "I";                
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxY_FLG]          = buf_Y_FLG;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL]          = buf_LEVEL;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxIN_NO]          = "";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxIN_SEQ]         = "";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxIN_DIV]         = "02";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxIN_YMD]         = "";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxITEM01]         = buf_ITEM01;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxITEM02]         = buf_ITEM02;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxITEM03]         = buf_ITEM03;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxITEM04]         = buf_ITEM04;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_PUR]      = buf_VALUE_PUR;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_PREV_IN]  = buf_VALUE_IN;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_IN]       = buf_VALUE_ADV_IN;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxBL_NO]          = "";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxINV_NO]         = "";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDEC_NO]         = "";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDEC_YMD]        = "";
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxPUR_CURRENCY]   = buf_PUR_CURRENCY;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxPUR_PRICE]      = buf_PUR_PRICE;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxCBD_CURRENCY]   = buf_CBD_CURRENCY;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxCBD_PRICE]      = buf_CBD_PRICE;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxPUR_NO]         = buf_PUR_NO;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxPUR_SEQ]        = buf_PUR_SEQ;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxBAR_CODE]       = buf_BAR_CODE;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxPUR_DIV]        = buf_PUR_DIV;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxMRP_REQ_FLG]    = buf_MRP_REQ_FLG;                
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxTRANSPORT_TYPE] = buf_TRANSPORT_TYPE;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVENDOR]         = buf_VENDOR;
                arg_request.fgrid_Main[inst_row, (int)ClassLib.TBSXI_IN_LIST_VJ.IxREMARKS]        = buf_REMARKS;
                #endregion
            }
            else
            {
        ...
        private void fgrid_Main_AfterEdit(object sender, C1.Win.C1FlexGrid.RowColEventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < fgrid_Main.Selections.Length; i++)
                {
                    ...
                    {
                        if (fgrid_Main[selectRow[i], (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxBAR_CODE].ToString() != fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxBAR_CODE].ToString())
                            break;
                        if (fgrid_Main[selectRow[i], (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxY_FLG].ToString() == "True")
                        {
                            fgrid_Main.Update_Row(j);
                            fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxY_FLG] = "True";
                        }
                        else
                        {
                            fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxY_FLG] = "False";
                            fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxDIVISION] = "";
                    ...
                    for (int i = fgrid_Main.Selection.r1; i <= fgrid_Main.Selection.r2; i++)
                    {
                        if (fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxY_FLG].ToString() == "True")
                        {
                            ...
                            if (fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxLEVEL].ToString() == "1")
                            {
                                ...
                                {
                                    if (fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxBAR_CODE].ToString() != fgrid_Main[j, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxBAR_CODE].ToString())
                                        break;
                        ...
                        else
                        {
                            ...
                            if (fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxLEVEL].ToString() == "1")
                            {
                                fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_BAR_VJ.IxDIVISION] = "";
