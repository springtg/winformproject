...
{
	public class Form_Incomming_Manager_VJ : COM.PCHWinForm.Form_Top
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_Incomming_Manager_VJ));
            ...
            this.cmb_PurDiv.CaptionStyle = style33;
            ...
            this.cmb_PurDiv.EvenRowStyle = style34;
            ...
            this.cmb_PurDiv.FooterStyle = style35;
            this.cmb_PurDiv.HeadingStyle = style36;
            this.cmb_PurDiv.HighLightRowStyle = style37;
            this.cmb_PurDiv.Images.Add(((System.Drawing.Image)(resources.GetObject("cmb_PurDiv.Images"))));
            this.cmb_PurDiv.ItemHeight = 15;
            this.cmb_PurDiv.Location = new System.Drawing.Point(109, 58);
            ...
            this.cmb_PurDiv.OddRowStyle = style38;
            ...
            this.cmb_PurDiv.SelectedStyle = style39;
            this.cmb_PurDiv.Size = new System.Drawing.Size(130, 20);
            this.cmb_PurDiv.Style = style40;
            ...
            this.lbl_Vendor.Location = new System.Drawing.Point(240, 58);
            ...
            this.lbl_PurDiv.Location = new System.Drawing.Point(8, 58);
            ...
            this.pnl_SearchImage.Controls.Add(this.txt_vendor);
            this.pnl_SearchImage.Controls.Add(this.cmb_PurDiv);
            ...
            this.pnl_SearchImage.Controls.Add(this.lbl_PurDiv);
            ...
            this.cmb_InUser.CaptionStyle = style49;
            ...
            this.cmb_InUser.EvenRowStyle = style50;
            ...
            this.cmb_InUser.FooterStyle = style51;
            this.cmb_InUser.HeadingStyle = style52;
            this.cmb_InUser.HighLightRowStyle = style53;
            ...
            this.cmb_InUser.OddRowStyle = style54;
            ...
            this.cmb_InUser.SelectedStyle = style55;
            this.cmb_InUser.Size = new System.Drawing.Size(130, 20);
            this.cmb_InUser.Style = style56;
            ...
            // txt_vendor
            // 
            this.txt_vendor.BackColor = System.Drawing.SystemColors.Window;
            this.txt_vendor.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.txt_vendor.Font = new System.Drawing.Font("Verdana", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txt_vendor.ImeMode = System.Windows.Forms.ImeMode.NoControl;
            this.txt_vendor.Location = new System.Drawing.Point(341, 58);
            this.txt_vendor.MaxLength = 100;
            this.txt_vendor.Name = "txt_vendor";
            this.txt_vendor.Size = new System.Drawing.Size(130, 21);
            this.txt_vendor.TabIndex = 286;
            // 
            // Form_Incomming_Manager_VJ
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
            this.ClientSize = new System.Drawing.Size(1016, 666);
            this.Controls.Add(this.pnl_Body);
            this.Controls.Add(this.pnl_Top);
            this.Name = "Form_Incomming_Manager_VJ";
        ...
        #region Resource
        public Form_Incomming_Manager_VJ()
        {
        ...
        private void tbtn_New_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
        {
            try
            {
                ...
                Incoming_VJ.Form_Barcode_Scan_List_VJ Barcode_List = new FlexCDC.Incoming_VJ.Form_Barcode_Scan_List_VJ(this);
                Barcode_List.ShowDialog();
            }
            catch
            {
		...
		{		
			...
			#region Grid Setting
			fgrid_Main.Set_Grid_CDC("SXI_IN_LIST_VJ", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
			fgrid_Main.Set_Action_Image(img_Action);
			fgrid_Main.Rows.Count  = fgrid_Main.Rows.Fixed;		
			fgrid_Main.Tree.Column = (int)ClassLib.TBSXI_IN_LIST_VJ.IxITEM01;			
			#endregion			
		}
		...
		{		
            ...
            arg_value[4] = txt_vendor.Text.Trim();
            arg_value[5] = "";
            arg_value[6] = cmb_PurDiv.SelectedValue.ToString();
            arg_value[7] = cmb_InUser.SelectedValue.ToString();

            DataTable dt_list = SELECT_SXI_IN_LIST(arg_value);
			
            #region Display Datalist 
			for(int i = 0; i < dt_list.Rows.Count; i++)
			{				
				int tree_level    = int.Parse(dt_list.Rows[i].ItemArray[(int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString());				
                ...
                if (fgrid_Main[fgrid_Main.Rows.Count - 1, (int)ClassLib.TBSXI_IN_LIST_VJ.IxSTATUS].ToString() == "Comfirmed")
                {
                    fgrid_Main.Rows[fgrid_Main.Rows.Count - 1].AllowEditing = false;
                }

				#region Level - Grid Edit & BackColor
				if(tree_level == 1)
				{					
        ...
        private DataTable SELECT_SXI_IN_LIST(string [] arg_value)
        {
        ...
        private void Save_Data()
		{
			...
			{				
				#region Update Data
				if(fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_VJ.IxDIVISION].ToString() == "U")
				{					

					if(fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString() =="1")
					{
						double Value_Pur     = Convert.ToDouble( fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_PUR].ToString());
						double Value_Prev_In = Convert.ToDouble( fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_PREV_IN].ToString());
						double Value_In      = Convert.ToDouble( fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_IN].ToString());
                        
						if(Value_Pur >= Value_Prev_In + Value_In)
						{
							#region Update Data 
							_In_No    = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxIN_NO].ToString();
							_Value_In = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_IN].ToString();
							_Bl_No    = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxBL_NO].ToString();
							_Inv_No   = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxINV_NO].ToString();   
							_Dec_No   = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDEC_NO].ToString(); 
							_Dec_Ymd  = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDEC_YMD].ToString();
							_Pur_Currency = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxPUR_CURRENCY].ToString();
							_Pur_Price = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxPUR_PRICE].ToString();
							_Remark   = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxREMARKS].ToString(); 
							#endregion

                            Save_SXI_In_Tail(fgrid_Main, i);                                

							fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDIVISION] = "";		
						}
						else 
						{						
							ClassLib.ComFunction.User_Message("Line : "+ i + "\r\n\r\n"
								+ " Material Name : "+ fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxITEM01].ToString() + "    Is Wrong Value. "+ "\r\n\r\n"
								+ " Save Failed..",
								"Save_Data", MessageBoxButtons.OK, MessageBoxIcon.Error);                                
							break;
						}
					}
					else if(fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString() == "2")
					{							
						fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDIVISION] = "";							
					}	
				}		
				...
				#region Insert Data
				if(fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_VJ.IxDIVISION].ToString() == "I")
				{				
					if(fgrid_Main[i,(int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString() =="1")
					{	
						double Value_Pur = Convert.ToDouble( fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_PUR].ToString());
        ...
        private void Insert_SXI_In_Tail(C1FlexGrid arg_fgrid, int arg_rowcnt, string arg_in_no)
        {
            ...
            MyOraDB.Parameter_Values[2] = fgrid_Main[arg_rowcnt, (int)ClassLib.TBSXI_IN_LIST_VJ.IxIN_DIV].ToString();
            MyOraDB.Parameter_Values[3] = _Value_In;
            MyOraDB.Parameter_Values[4] = fgrid_Main[arg_rowcnt, (int)ClassLib.TBSXI_IN_LIST_VJ.IxBAR_CODE].ToString();
            ...
            MyOraDB.Parameter_Values[11] = fgrid_Main[arg_rowcnt, (int)ClassLib.TBSXI_IN_LIST_VJ.IxREMARKS].ToString();
        ...
        private void Save_SXI_In_Tail(C1FlexGrid arg_fgrid, int arg_rowcnt)
		{
			...
			//04. DATA 정의 			
			MyOraDB.Parameter_Values[0]  = fgrid_Main[arg_rowcnt, (int)ClassLib.TBSXI_IN_LIST_VJ.IxDIVISION].ToString();			
			MyOraDB.Parameter_Values[1]  = cmb_Factory.SelectedValue.ToString();
			MyOraDB.Parameter_Values[2]  = fgrid_Main[arg_rowcnt, (int)ClassLib.TBSXI_IN_LIST_VJ.IxIN_NO].ToString();
			MyOraDB.Parameter_Values[3]  = fgrid_Main[arg_rowcnt, (int)ClassLib.TBSXI_IN_LIST_VJ.IxBAR_CODE].ToString();			
        ...
        private void Confirm_Data()
        {
            ...
            for (int i = fgrid_Main.Rows.Fixed; i < fgrid_Main.Rows.Count; i++)
            {
                if (fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString() == "1")
                {
                    string arg_bar_code = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxBAR_CODE].ToString();
                    string arg_value_in = fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxVALUE_IN].ToString();
				...
				for(int i = fgrid_Main.Selection.r1; i < fgrid_Main.Rows.Count; i++)
				{
					...
					{					
						if(fgrid_Main[i, (int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString() == "1")
						{
							...
							{						
								if(fgrid_Main[j,(int)ClassLib.TBSXI_IN_LIST_VJ.IxLEVEL].ToString() != "2") 
									break;							
