...
namespace FlexCDC.FOB
{
    public partial class Form_EIS_MatPrice_Inspection_FOB : COM.APSWinForm.Form_Top
    {
        ...
        private void Init_Control()
        {
            ...
            ClassLib.ComCtl.Set_ComboList(dt_month, cmb_PlanMonth_From, 0, 0, false, COM.ComVar.ComboList_Visible.Code);
            ClassLib.ComCtl.Set_ComboList(dt_month, cmb_PlanMonth_To, 0, 0, false, COM.ComVar.ComboList_Visible.Code);
            ...
            ClassLib.ComCtl.Set_ComboList_Multi(dt_ret, cmb_Year, new int[] { 0, 1, 2 }, false);
            string[] titles = new string[] { "Year", "Month from", "Month to" };
            int[] width = new int[] { 150, 100, 100 };
            bool[] visible = new bool[] { true, false, false };
            ClassLib.ComCtl.SetComboStyle(cmb_Year, titles, width, visible, "Year");
        ...
        private void Init_Control_cmb_ModelCd()
        {
            ...
            ClassLib.ComCtl.Set_ComboList(dt_ret, cmb_ModelCd, 0, 1, true, COM.ComVar.ComboList_Visible.Code_Name);
        ...
        private void Init_Control_cmb_StyleCd()
        {
            ...
            ClassLib.ComCtl.Set_ComboList_Multi(dt_ret, cmb_StyleCd, new int[] { 0, 1, 2, 3, 4, 5 }, true);
        ...
        private void Event_cmb_Factory_SelectedValueChanged()
        {
            ...
            ClassLib.ComCtl.Set_ComboList(dt_ret, cmb_Category, 1, 2, true, COM.ComVar.ComboList_Visible.Code_Name);
            ...
            string arg_division)
        {
            ...
            try
            {
                ...
                //01.PROCEDURE명
                MyOraDB.Process_Name = "PKG_EMM_PRICE_SEARCH_ANALYSIS.SELECT_FOB_COST_VS_TRADE";
