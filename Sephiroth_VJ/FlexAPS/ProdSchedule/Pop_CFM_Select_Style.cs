...
//		}
		...
		private void InitializeComponent()
		{
			...
			this.btnClose.Location = new System.Drawing.Point(898, 24);
			...
			this.btnSave.Location = new System.Drawing.Point(810, 24);
		...
		private void Init_Form()
		{
			...
			ClassLib.ComCtl.Set_ComboList(vDT, cmbFactory, 0, 1, false, COM.ComVar.ComboList_Visible.Code);
		...
		private void Save_CFM_Style(int iRow)
		{
			...
			OraDB.Parameter_Values[0]  = grdCFM[iRow, 1].ToString();   //Factory
			OraDB.Parameter_Values[1]  = grdCFM[iRow, 5].ToString();   //Style Code
			OraDB.Parameter_Values[2]  = grdCFM[iRow, 6].ToString();   //Style name
			OraDB.Parameter_Values[3]  = grdCFM[iRow, 3].ToString();   //Season Cd
			OraDB.Parameter_Values[4]  = grdCFM[iRow, 4].ToString();   //DPO ID
			OraDB.Parameter_Values[5]  = grdCFM[iRow, 2].ToString();   //Ship Date
			OraDB.Parameter_Values[6]  = grdCFM[iRow, 7].ToString();   //Gender
			OraDB.Parameter_Values[7]  = grdCFM[iRow, 8].ToString();   //Cat Cd
			OraDB.Parameter_Values[8]  = grdCFM[iRow, 9].ToString();   //Category
			OraDB.Parameter_Values[9]  = grdCFM[iRow, 13].ToString();  //Qty
			OraDB.Parameter_Values[10] = grdCFM[iRow, 10].ToString();  //Developer
			OraDB.Parameter_Values[11] = "";                           //Spec Date
			OraDB.Parameter_Values[12] = "";                           //SBook Date
			OraDB.Parameter_Values[13] = "";                           //CFM Shoe Date
			OraDB.Parameter_Values[14] = grdCFM[iRow, 11].ToString();  //Assy Date1
			OraDB.Parameter_Values[15] = grdCFM[iRow, 12].ToString();  //Assy Date2
