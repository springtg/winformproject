...
{
	public class Form_PD_WorkSheetByStyle : COM.APSWinForm.Form_Top
	{
		...
		public Form_PD_WorkSheetByStyle()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_PD_WorkSheetByStyle));
			...
			// 
			// Form_PD_WorkSheetByStyle
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.pnl_B);
			this.Name = "Form_PD_WorkSheetByStyle";
			this.Text = "Daily WorkSheet By Sequence ";
			this.Load += new System.EventHandler(this.Form_PD_WorkSheetByStyle_Load);
		...
		private void Init_Form()
		{
			...
			{ 
				...
				//Title
				this.Text = "Daily WorkSheet By Style";
                lbl_MainTitle.Text = "Daily WorkSheet By Style";
 

				fgrid_WorkSheet.Set_Grid("SPD_DAILY_WORKSHEET_TS_BSC", "3", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
...
//				fgrid_WorkSheet.Subtotal(AggregateEnum.Sum, 2, (int)ClassLib.TBSPD_DAILY_WORKSHEET_TS_SEARCH_BSC.IxMLINE_CD, i, "Line Sum.");
		...
		private void Form_PD_WorkSheetByStyle_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		} 
			...
			string arg_mat_area)
		{
			...
			{ 
				...
				string process_name = "PKG_SPD_WORKSHEET_SEARCH_BSC.SELECT_DAILY_WORKSHEET_STYLE";
