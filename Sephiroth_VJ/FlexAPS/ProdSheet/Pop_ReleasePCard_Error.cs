...
{
	public class Pop_ReleasePCard_Error : COM.APSWinForm.Pop_Large
	{
		...
		public Pop_ReleasePCard_Error(string arg_confirm_ymd)
		{
			// 이 호출은 Windows Form 디자이너에 필요합니다.
			InitializeComponent();
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_ReleasePCard_Error));
			...
			this.lbl_MainTitle.Text = "Pass Card Error List";
			// 
			// btn_Close
			// 
			...
			this.fgrid_Main.TabIndex = 291;
			// 
			// Pop_ReleasePCard_Error
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(6, 14);
			this.ClientSize = new System.Drawing.Size(694, 455);
			this.Controls.Add(this.btn_Close);
			this.Controls.Add(this.fgrid_Main);
			this.Name = "Pop_ReleasePCard_Error";
			this.Text = "Pass Card Error List";
		...
		private void Init_Form()
		{
			...
			{ 
				...
				//Title
				this.Text = "Passcard Error List";
				lbl_MainTitle.Text = "Passcard Error List";
  
  
				fgrid_Main.Set_Grid("SPD_PCARD_ERROR_BSC", "1", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, true);
				fgrid_Main.ExtendLastCol = false; 
				fgrid_Main.Font = new Font("Verdana", 7);



				DataTable dt_ret = Select_PassCard_Error_List(_ConfirmYmd);
		...
		/// <summary>
		/// Select_PassCard_Error_List : 
		/// </summary> 
		/// <param name="arg_confirm_ymd"></param>
		/// <returns></returns>
		private DataTable Select_PassCard_Error_List(string arg_confirm_ymd) 
		{  
			...
			try
			{
				...
				MyOraDB.Process_Name = "PKG_SPD_WORKSHEET_BSC.SELECT_PASSCARD_ERROR_LIST";
  
				MyOraDB.Parameter_Name[0] = "ARG_DIR_REQ_YMD";  
				MyOraDB.Parameter_Name[1] = "OUT_CURSOR";
 
				MyOraDB.Parameter_Type[0] = (int)OracleType.VarChar; 
				MyOraDB.Parameter_Type[1] = (int)OracleType.Cursor;
			   
				MyOraDB.Parameter_Values[0] = arg_confirm_ymd;  
