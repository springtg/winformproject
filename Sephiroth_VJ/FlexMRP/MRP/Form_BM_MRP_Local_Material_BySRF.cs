...
namespace FlexMRP.MRP
{
	public class Form_BM_MRP_Local_Material_BySRF : COM.PCHWinForm.Form_Top, IOperation
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_BM_MRP_Local_Material_BySRF));
			...
			this.lbl_MainTitle.Text = "Local/ LLT Material List By SRF";
			// 
			// tbtn_Print
			// 
			...
			this.Text = "Local/ LLT Material List By SRF";
		...
		{						
			// form set
			this.Text = "Local/ LLT Material List By SRF";
			lbl_MainTitle.Text = "Local/ LLT Material List By SRF";
