...
{
	public class Form_Training_Master : COM.TrainingWinForm.Form_Top
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_Training_Master));
			...
			// 
			// Form_Training_Master
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.c1Sizer1);
			this.Name = "Form_Training_Master";
			this.Load += new System.EventHandler(this.Form_Training_Master_Load);
		...
		private int _colT_GRP_CODE   = (int)ClassLib.TBSIM_TRAINING_MASTER.IxT_GRP_CODE;
		...
		private void Form_Training_Master_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		}
		...
		{						
			...
			// grid set
			fgrid_main.Set_Grid("SIM_TRAINING", "2", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
		...
		private void Tbtn_SearchProcess()
		{
			try
			{
				...
				string vProcedure     = "PKG_SIM_MASTER.SELECT_SIM_TRAINING_MASTER_01";
		...
		private void Tbtn_SaveProcess()
		{
			try
			{
				...
				if (SAVE_SIM_TRAINING_MASTER(true))
				{
		...
		public bool SAVE_SIM_TRAINING_MASTER(bool doExecute)
		{
			try
			{
				int save_ct = 0;   
				...
				//01.PROCEDURE NAME
				MyOraDB.Process_Name = "PKG_SIM_MASTER.SAVE_SIM_TRAINING_MASTER_2";

				//02.ARGURMENT NAME
				MyOraDB.Parameter_Name[ 0] = "ARG_DIVISION";
				MyOraDB.Parameter_Name[ 1] = "ARG_FACTORY";
				MyOraDB.Parameter_Name[ 2] = "ARG_T_CODE";
				MyOraDB.Parameter_Name[ 3] = "ARG_T_NAME";
				MyOraDB.Parameter_Name[ 4] = "ARG_T_GRP_CODE";
				MyOraDB.Parameter_Name[ 5] = "ARG_MEASURE_CODE";
				MyOraDB.Parameter_Name[ 6] = "ARG_GOAL_VALUE";
				MyOraDB.Parameter_Name[ 7] = "ARG_GOAL_DESC";
				...
				for (int iRow = fgrid_main.Rows.Fixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					if(fgrid_main[iRow, 0].ToString() != "")
					{
						...
						MyOraDB.Parameter_Values[para_ct+ 3] = fgrid_main[iRow, _colT_NAME].ToString();
						MyOraDB.Parameter_Values[para_ct+ 4] = fgrid_main[iRow, _colT_GRP_CODE].ToString();
						MyOraDB.Parameter_Values[para_ct+ 5] = fgrid_main[iRow, _colMEASURE_CODE].ToString();
						MyOraDB.Parameter_Values[para_ct+ 6] = fgrid_main[iRow, _colGOAL_VALUE].ToString();
						MyOraDB.Parameter_Values[para_ct+ 7] = fgrid_main[iRow, _colGOAL_DESC].ToString();
		...
		public DataTable SELECT_TRAINING_LIST(string arg_procedure)
		{ 
			DataSet vDt;
