...
{
	public class Form_Training_Management : COM.TrainingWinForm.Form_Top
	{
		...
		private System.Windows.Forms.ContextMenu mnu_Popup;
		private System.Windows.Forms.MenuItem mnu_Trainee;
		private System.Windows.Forms.MenuItem mnu_Schedule;
		private System.Windows.Forms.MenuItem mnu_Attendance_Mgnt;
		private System.ComponentModel.IContainer components = null;

		public Form_Training_Management()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_Training_Management));
			this.c1Sizer1 = new C1.Win.C1Sizer.C1Sizer();
			this.panel2 = new System.Windows.Forms.Panel();
			this.fgrid_main = new COM.FSP();
			this.mnu_Popup = new System.Windows.Forms.ContextMenu();
			this.mnu_Trainee = new System.Windows.Forms.MenuItem();
			this.mnu_Schedule = new System.Windows.Forms.MenuItem();
			this.mnu_Attendance_Mgnt = new System.Windows.Forms.MenuItem();
			...
			this.fgrid_main.ContextMenu = this.mnu_Popup;
			...
			// mnu_Popup
			// 
			this.mnu_Popup.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
																					  this.mnu_Trainee,
																					  this.mnu_Schedule,
																					  this.mnu_Attendance_Mgnt});
			this.mnu_Popup.Popup += new System.EventHandler(this.mnu_Popup_Popup);
			// 
			// mnu_Trainee
			// 
			this.mnu_Trainee.Index = 0;
			this.mnu_Trainee.Text = "Trainee Infor";
			this.mnu_Trainee.Click += new System.EventHandler(this.mnu_Trainee_Click);
			// 
			// mnu_Schedule
			// 
			this.mnu_Schedule.Index = 1;
			this.mnu_Schedule.Text = "Schedule Infor";
			this.mnu_Schedule.Click += new System.EventHandler(this.mnu_Schedule_Click);
			// 
			// mnu_Attendance_Mgnt
			// 
			this.mnu_Attendance_Mgnt.Index = 2;
			this.mnu_Attendance_Mgnt.Text = "Attendance Mgnt";
			this.mnu_Attendance_Mgnt.Click += new System.EventHandler(this.mnu_Attendance_Mgnt_Click);
			// 
			// pnl_Search
			// 
			...
			this.cmb_Group.Location = new System.Drawing.Point(109, 81);
			...
			this.txt_Training.Location = new System.Drawing.Point(109, 59);
			...
			this.cmb_Training.Location = new System.Drawing.Point(310, 59);
			...
			this.cmb_Training.TabIndex = 153;
			...
			this.picb_MR.Location = new System.Drawing.Point(912, 24);
			...
			this.picb_ML.Size = new System.Drawing.Size(8, 250);
			...
			this.pictureBox6.Size = new System.Drawing.Size(904, 399);
			...
			this.btn_Insert.Location = new System.Drawing.Point(912, 8);
			...
			// 
			// Form_Training_Management
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.c1Sizer1);
			this.Name = "Form_Training_Management";
			this.Load += new System.EventHandler(this.Form_Training_Management_Load);
		...
		private void Form_Training_Management_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		}
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "Training Management";
			this.Text		   = "Training";


			// grid set
			fgrid_main.Set_Grid("SIM_TRAINING_MGNT", "1", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
		...
		private void Tbtn_SaveProcess()
		{
			try
			{
				...
				if (SAVE_SIM_TRAINING_MGNT(true))
				{
		...
		public bool SAVE_SIM_TRAINING_MGNT(bool doExecute)
		{
			try
			{
				int save_ct = 0;   
				...
				//01.PROCEDURE NAME
				MyOraDB.Process_Name = "PKG_SIM_TRAINING_MGNT.SAVE_SIM_TRAINING_MGNT";
				...
				MyOraDB.Parameter_Name[ 4] = "ARG_GRP_CODE";
				MyOraDB.Parameter_Name[ 5] = "ARG_WAVE";
				MyOraDB.Parameter_Name[ 6] = "ARG_LOCATION_DIV";
				MyOraDB.Parameter_Name[ 7] = "ARG_LANG_DIV";
				MyOraDB.Parameter_Name[ 8] = "ARG_TRAINER_ID";
				MyOraDB.Parameter_Name[ 9] = "ARG_TARGET";
				MyOraDB.Parameter_Name[ 10] = "ARG_GOAL_VALUE";
				MyOraDB.Parameter_Name[ 11] = "ARG_GOAL_DESC";
				MyOraDB.Parameter_Name[ 12] = "ARG_REMARK";
				MyOraDB.Parameter_Name[ 13] = "ARG_UPDATE_USER";
				...
				for (int iRow = fgrid_main.Rows.Fixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					if(fgrid_main[iRow, 0].ToString() != "")
					{
						...
						MyOraDB.Parameter_Values[para_ct+ 4 ] = fgrid_main[iRow, _colGRP_CODE].ToString();
						MyOraDB.Parameter_Values[para_ct+ 5 ] = fgrid_main[iRow, _colWAVE].ToString();
						MyOraDB.Parameter_Values[para_ct+ 6 ] = fgrid_main[iRow, _colLOCATION_DIV].ToString();
						MyOraDB.Parameter_Values[para_ct+ 7 ] = fgrid_main[iRow, _colLANG_DIV].ToString();
						MyOraDB.Parameter_Values[para_ct+ 8 ] = fgrid_main[iRow, _colTRAINER_ID].ToString();
						MyOraDB.Parameter_Values[para_ct+ 9 ] = fgrid_main[iRow, _colTARGET].ToString();
						MyOraDB.Parameter_Values[para_ct+ 10 ] = fgrid_main[iRow, _colGOAL_VALUE].ToString();
						MyOraDB.Parameter_Values[para_ct+ 11] = fgrid_main[iRow, _colGOAL_DESC].ToString();
						MyOraDB.Parameter_Values[para_ct+ 12] = fgrid_main[iRow, _colREMARK].ToString();
						MyOraDB.Parameter_Values[para_ct+ 13] = COM.ComVar.This_User;
		...
		private void fgrid_main_Click(object sender, System.EventArgs e)
		{
			...
			if ((iCol == _colT_NAME)&&(iRow >= _Rowfixed)&&(fgrid_main.Cols[iCol].ComboList == "...")&&(_temp_row==iRow)&&(_temp_col==iCol))
			{					
				Get_Training_Data();	
				fgrid_main.Cols[iCol].ComboList = "";
				
			}
			else if ((iCol == _colTRAINER_ID)&&(iRow >= _Rowfixed)&&(fgrid_main.Cols[iCol].ComboList == "...")&&(_temp_row==iRow)&&(_temp_col==iCol))
			{
				Get_Trainer_Data();	
				fgrid_main.Cols[iCol].ComboList = "";
			}
			...
			{
				if ((iCol == _colT_NAME) || (iCol == _colTRAINER_ID))
				{
		...
		private void Get_Training_Data()
		{
			...
			Pop_Training_Master pop_training = new Pop_Training_Master();
			...
			if (COM.ComVar.Parameter_PopUp.Length > 1)
			{
				...
				fgrid_main[iRow, _colGOAL_VALUE]     = COM.ComVar.Parameter_PopUp[2];
				fgrid_main[iRow, _colGOAL_DESC]      = COM.ComVar.Parameter_PopUp[3];
		...
		private void Get_Trainer_Data()
		{
			int    iRow   = fgrid_main.Selection.r1;
			int    iCol   = fgrid_main.Selection.c1;

			COM.ComVar.Parameter_PopUp		 = new string[0];
			Pop_Trainer_Master pop_trainer = new Pop_Trainer_Master();
			pop_trainer.ShowDialog();

			if (COM.ComVar.Parameter_PopUp.Length > 1)
			{
				fgrid_main[iRow, _colTRAINER_ID]         = COM.ComVar.Parameter_PopUp[0];
				fgrid_main[iRow, _colTRAINER_NAME]       = COM.ComVar.Parameter_PopUp[1];
...
//			this.Grid_BeforeEditProcess();
		...
		private void mnu_Schedule_Click(object sender, System.EventArgs e)
		{
			Get_Schedule_Form();
		}

		private void Get_Schedule_Form()
		{
			int    iRow   = fgrid_main.Selection.r1;
			int    iCol   = fgrid_main.Selection.c1;
			...
			COM.ComVar.Parameter_PopUp		 = new string[0];
			Form_Training_PGM_Schedule form_shcedule = new Form_Training_PGM_Schedule(keys);
			form_shcedule.ShowDialog();
			form_shcedule.Dispose();

		}

		private void mnu_Popup_Popup(object sender, System.EventArgs e)
		{
			if (fgrid_main.Selection.c1 == _colSEQ)
			{
				mnu_Trainee.Enabled = true;
				mnu_Schedule.Enabled = true;
				mnu_Attendance_Mgnt.Enabled = true;
			}
			else
			{
				mnu_Trainee.Enabled = false;
				mnu_Schedule.Enabled = false;
				mnu_Attendance_Mgnt.Enabled = false;
			}

		}

		private void mnu_Trainee_Click(object sender, System.EventArgs e)
		{
			Get_Trainee_Information_Form();
		}

		private void Get_Trainee_Information_Form()
		{
			int    iRow   = fgrid_main.Selection.r1;
			int    iCol   = fgrid_main.Selection.c1;
			...
			COM.ComVar.Parameter_PopUp	= new string[0];
			Form_Trainee_Information form_trainee = new Form_Trainee_Information(keys);
			form_trainee.ShowDialog();
			form_trainee.Dispose();
		}

		private void mnu_Attendance_Mgnt_Click(object sender, System.EventArgs e)
		{
			Get_Training_Attendance_Form();
		}

		private void Get_Training_Attendance_Form()
		{
			int    iRow   = fgrid_main.Selection.r1;
			int    iCol   = fgrid_main.Selection.c1;
			...
			COM.ComVar.Parameter_PopUp	= new string[0];
			Form_Training_Attendance form_training_attendance = new Form_Training_Attendance(keys);
			form_training_attendance.ShowDialog();
			form_training_attendance.Dispose();
		}
