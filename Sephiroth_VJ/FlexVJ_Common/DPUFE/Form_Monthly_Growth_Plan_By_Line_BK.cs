...
namespace FlexVJ_Common.DPUFE
{
	public class Form_Monthly_Growth_Plan_By_Line : COM.VJ_CommonWinForm.Pop_Large
	{
		...
		private void Init_cbm_Season ()
		{
			...
			{
				string _temp="20"+year.ToString()+""+"0801";
				string _temp2="20"+year.ToString()+""+"1030";
			...
			{
				string _temp="20"+year.ToString()+""+"0201";
				string _temp2="20"+year.ToString()+""+"0430";
				dpick_date_from.Value= DateTime.ParseExact(_temp,"yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture );
				dpick_date_to.Value= DateTime.ParseExact(_temp2,"yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture );
			}
			...
			{
				int l_year=year+1;
				string _temp="20"+year+""+"1101";
				string _temp2="20"+l_year+""+"0130";
				dpick_date_from.Value= DateTime.ParseExact(_temp,"yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture );
				dpick_date_to.Value= DateTime.ParseExact(_temp2,"yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture );
			}
			if (cbm_Season.SelectedValue.ToString()=="HO")
			{
				string _temp="20"+year+""+"0501";
				string _temp2="20"+year+""+"0730";
				dpick_date_from.Value= DateTime.ParseExact(_temp,"yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture );
				dpick_date_to.Value= DateTime.ParseExact(_temp2,"yyyyMMdd", System.Globalization.CultureInfo.CurrentCulture );
			}
		}
...
//			tbtn_Search_Click(tbtn_Search,null);
		...
		private void txt_Year_TextChanged(object sender, System.EventArgs e)
		{
			...
			string l_Tmp = dpick_date_from.Value.ToString("yyyy/MM/dd");
			string l_Tmp1 = dpick_date_to.Value.ToString("yyyy/MM/dd");
			l_Tmp = l_Tmp.Substring(0,2) + l_txt_Year.Text + l_Tmp.Substring(4,6);
			l_Tmp1 = l_Tmp1.Substring(0,2) + l_txt_Year.Text + l_Tmp1.Substring(4,6);
			dpick_date_from.Value = DateTime.ParseExact(l_Tmp,"yyyy/MM/dd", System.Globalization.CultureInfo.CurrentCulture );
			dpick_date_to.Value = DateTime.ParseExact(l_Tmp1,"yyyy/MM/dd", System.Globalization.CultureInfo.CurrentCulture );
			tbtn_Search_Click(tbtn_Search,null);
		}
