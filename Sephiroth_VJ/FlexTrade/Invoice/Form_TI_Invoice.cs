...
{
	public class Form_TI_Invoice : COM.TradeWinForm.Form_Top
	{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_TI_Invoice));
			...
			this.groupBox2.Controls.Add(this.rad_C);
			...
			this.groupBox2.TabIndex = 580;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "Invoice Div.";
			// 
			// rad_C
			// 
			this.rad_C.Location = new System.Drawing.Point(112, 16);
			this.rad_C.Name = "rad_C";
			this.rad_C.Size = new System.Drawing.Size(41, 16);
			this.rad_C.TabIndex = 36;
			this.rad_C.Tag = "2";
			this.rad_C.Text = "CT";
			// 
			// rad_B
			// 
			this.rad_B.Location = new System.Drawing.Point(64, 16);
			this.rad_B.Name = "rad_B";
			this.rad_B.Size = new System.Drawing.Size(41, 16);
			...
			// rad_A
			// 
			this.rad_A.Location = new System.Drawing.Point(8, 16);
			this.rad_A.Name = "rad_A";
			this.rad_A.Size = new System.Drawing.Size(54, 16);
			this.rad_A.TabIndex = 34;
			this.rad_A.Tag = "1";
			this.rad_A.Text = "Nego";
			// 
			// txt_invoice_no
			// 
			...
			this.txt_invoice_no.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F);
			...
			this.btn_Tax.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F);
			...
			this.btn_Invoice.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F);
			...
			this.txtstyle_cd.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F);
			this.txtstyle_cd.ImeMode = System.Windows.Forms.ImeMode.Disable;
			this.txtstyle_cd.Location = new System.Drawing.Point(485, 40);
			...
			this.txt_po_no.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F);
			this.txt_po_no.ImeMode = System.Windows.Forms.ImeMode.Disable;
			this.txt_po_no.Location = new System.Drawing.Point(109, 62);
			...
			this.lbl_po_item.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.lbl_po_item.ImageIndex = 0;
			this.lbl_po_item.ImageList = this.img_Label;
			this.lbl_po_item.Location = new System.Drawing.Point(8, 84);
			...
			this.txt_po_item.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F);
			this.txt_po_item.ImeMode = System.Windows.Forms.ImeMode.Disable;
			this.txt_po_item.Location = new System.Drawing.Point(109, 84);
			...
			this.lbl_po_no.Font = new System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.lbl_po_no.ImageIndex = 0;
			this.lbl_po_no.ImageList = this.img_Label;
			this.lbl_po_no.Location = new System.Drawing.Point(8, 62);
		...
		private	string	_Tag;		
		private	string	_sPo_Type;




		private int _colT_LEVEL			     = (int)ClassLib.TBSTM_INVOICE.IxT_LEVEL;
		private int _colCHK			         = (int)ClassLib.TBSTM_INVOICE.IxCHK;
		private int _colFACTORY 		     = (int)ClassLib.TBSTM_INVOICE.IxFACTORY;
		private int _colSTYLE_CD		     = (int)ClassLib.TBSTM_INVOICE.IxSTYLE_CD;
		private int _colSTYLE_NM		     = (int)ClassLib.TBSTM_INVOICE.IxSTYLE_NM;
		private int _colINVOICE_DATE	     = (int)ClassLib.TBSTM_INVOICE.IxSTYLE_CD;
		private int _colINVOICE_NO		     = (int)ClassLib.TBSTM_INVOICE.IxSTYLE_NM;
		private int _colSHIP_DATE		     = (int)ClassLib.TBSTM_INVOICE.IxGEN_NM;
		private int _colGEN_NM			     = (int)ClassLib.TBSTM_INVOICE.IxGEN_NM;
		private int _colGEN_CD			     = (int)ClassLib.TBSTM_INVOICE.IxGEN_CD;
		private int _colSEASON 			     = (int)ClassLib.TBSTM_INVOICE.IxSEASON;
		private int _colORDER_SHOE_QTY       = (int)ClassLib.TBSTM_INVOICE.IxORDER_SHOE_QTY;
		private int _colINVOICE_SHOE_QTY     = (int)ClassLib.TBSTM_INVOICE.IxINVOICE_SHOE_QTY;
		private int _colINVOICE_CT_QTY       = (int)ClassLib.TBSTM_INVOICE.IxINVOICE_CT_QTY;
		private int _colPO_NO                = (int)ClassLib.TBSTM_INVOICE.IxPO_NO;
		private int _colPO_ITEM              = (int)ClassLib.TBSTM_INVOICE.IxPO_ITEM;
		private int _colPO_NO_K              = (int)ClassLib.TBSTM_INVOICE.IxPO_NO_K;
		private int _colPO_ITEM_K            = (int)ClassLib.TBSTM_INVOICE.IxPO_ITEM_K;

		private int _colORDER_CS_FOB         = (int)ClassLib.TBSTM_INVOICE.IxORDER_CS_FOB;
		private int _colFOB_DIV              = (int)ClassLib.TBSTM_INVOICE.IxFOB_DIV;
		private int _colTRADE_CS_FOB         = (int)ClassLib.TBSTM_INVOICE.IxTRADE_CS_FOB;
		private int _colTRADE_FACTORY_FOB    = (int)ClassLib.TBSTM_INVOICE.IxTRADE_FACTORY_FOB;

		private int _colAMOUNT               = (int)ClassLib.TBSTM_INVOICE.IxAMOUNT;
		private int _colINVOICE_KEY    	     = (int)ClassLib.TBSTM_INVOICE.IxINVOICE_KEY;
		private int _colSIZE_DIV    	     = (int)ClassLib.TBSTM_INVOICE.IxSIZE_DIV;
		private int _colSIZE_FROM    	     = (int)ClassLib.TBSTM_INVOICE.IxSIZE_FROM;
		private int _colSIZE_TO     	     = (int)ClassLib.TBSTM_INVOICE.IxSIZE_TO;
		private int _colCURRENCY     	     = (int)ClassLib.TBSTM_INVOICE.IxCURRENCY;
		private int _colLOT_DIV     	     = (int)ClassLib.TBSTM_INVOICE.IxLOT_DIV;
		private int _colWERKS			   	 = (int)ClassLib.TBSTM_INVOICE.IxWERKS;
		private int _colFFS_SHP_TO_ACCT   	 = (int)ClassLib.TBSTM_INVOICE.IxFFS_SHP_TO_ACCT;
		private int _colCUST_XREF		   	 = (int)ClassLib.TBSTM_INVOICE.IxCUST_XREF;
		private int _colOUTPUT_PROFILE_ID	 = (int)ClassLib.TBSTM_INVOICE.IxOUTPUT_PROFILE_ID;
		private int _colFFS_STENCIL_DEST   	 = (int)ClassLib.TBSTM_INVOICE.IxFFS_STENCIL_DEST;
		private int _colFFS_STENCIL_SHIPTO	 = (int)ClassLib.TBSTM_INVOICE.IxFFS_STENCIL_SHIPTO;
		private int _colFFS_STENCIL_ORIGIN	 = (int)ClassLib.TBSTM_INVOICE.IxFFS_STENCIL_ORIGIN;
		private int _colAFS_CATEGORY	     = (int)ClassLib.TBSTM_INVOICE.IxAFS_CATEGORY;
		private int _colFSP					 = (int)ClassLib.TBSTM_INVOICE.IxFSP;
		private int _colLC_NO				 = (int)ClassLib.TBSTM_INVOICE.IxLC_NO;
		private int _colM_BL_NO				 = (int)ClassLib.TBSTM_INVOICE.IxM_BL_NO;
		private int _colPL_NO				 = (int)ClassLib.TBSTM_INVOICE.IxPL_NO;
		private int _colCUST_PO_NO			 = (int)ClassLib.TBSTM_INVOICE.IxCUST_PO_NO;
		private int _colAIR_CHARGES			 = (int)ClassLib.TBSTM_INVOICE.IxAIR_CHARGES;		
		private int _colPO_TYPE 		     = (int)ClassLib.TBSTM_INVOICE.IxPO_TYPE;

		private int _colSUB_CATEGORY_NAME    = (int)ClassLib.TBSTM_INVOICE.IxSUB_CATEGORY_NAME;
		private int _colCONTRACT_NO    	     = (int)ClassLib.TBSTM_INVOICE.IxCONTRACT_NO;
		private int _colLINE_REMARK    	     = (int)ClassLib.TBSTM_INVOICE.IxLINE_REMARK;

		private int _colBUYER_CD    	     = (int)ClassLib.TBSTM_INVOICE.IxBUYER_CD;
		private int _colBUYER_NM    	     = (int)ClassLib.TBSTM_INVOICE.IxBUYER_NM;

		private int _colBUKRS 		         = (int)ClassLib.TBSTM_INVOICE.IxBUKRS;
		private int _colFFS_SOLDTO_CD    	 = (int)ClassLib.TBSTM_INVOICE.IxFFS_SOLDTO_CD;
		private int _colFFS_NAME2    		 = (int)ClassLib.TBSTM_INVOICE.IxFFS_NAME2;
		...
		private void fgrid_main_Click(object sender, System.EventArgs e)
		{
			...
			if (sLevel.Equals("2"))
			{
				...
				{
					if ((iCol == _colFFS_SOLDTO_CD) || (iCol == _colBUYER_CD))
					{
		...
		private bool GET_MERCURY_INVOICE(bool doExecute)
		{
			try
			{
		...
		private void tbtn_Save_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
		{
			...
			{				
				MessageBox.Show("Omitted Invoice date/FSP/LC#");
			}
		}
...
//				return;
		...
		public bool SAVE_STM_INVOICE(bool doExecute)
		{
			try
			{
				...
				//01.PROCEDURE명
				MyOraDB.Process_Name = "PKG_STM_INVOICE.SAVE_STM_INVOICE_01";
				...
				MyOraDB.Parameter_Name[34] = "ARG_GEN_CD";
				MyOraDB.Parameter_Name[35] = "ARG_SEASON";
				MyOraDB.Parameter_Name[36] = "ARG_BUYER_CD";
				...
				for (int iRow = fgrid_main.Rows.Fixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					if(fgrid_main[iRow, 0].ToString() != "")
					{
						...
						MyOraDB.Parameter_Values[para_ct+27] = (fgrid_main[iRow, _colAFS_CATEGORY]        == null) ? fgrid_main[iRow-1, _colSUB_CATEGORY_NAME].ToString() : fgrid_main[iRow, _colAFS_CATEGORY].ToString();
						...
						if ((fgrid_main[iRow, _colSUB_CATEGORY_NAME] == null)||(fgrid_main[iRow, _colSUB_CATEGORY_NAME].ToString() == ""))
							MyOraDB.Parameter_Values[para_ct+30] = fgrid_main[iRow-1, _colSUB_CATEGORY_NAME].ToString();
						else
							MyOraDB.Parameter_Values[para_ct+30] = fgrid_main[iRow, _colSUB_CATEGORY_NAME].ToString();
						...
						MyOraDB.Parameter_Values[para_ct+33] = (fgrid_main[iRow, _colFFS_SOLDTO_CD]       == null) ? "__" : fgrid_main[iRow, _colFFS_SOLDTO_CD].ToString();

						if ((fgrid_main[iRow, _colGEN_CD] == null)||(fgrid_main[iRow, _colGEN_CD].ToString() == "__"))
							MyOraDB.Parameter_Values[para_ct+34] = fgrid_main[iRow-1, _colGEN_CD].ToString();
						else
							MyOraDB.Parameter_Values[para_ct+34] = fgrid_main[iRow,   _colGEN_CD].ToString();

						MyOraDB.Parameter_Values[para_ct+35] = (fgrid_main[iRow, _colSEASON]       == null) ? "__" : fgrid_main[iRow, _colSEASON].ToString();
						MyOraDB.Parameter_Values[para_ct+36] = (fgrid_main[iRow, _colBUYER_CD]       == null) ? "__" : fgrid_main[iRow, _colBUYER_CD].ToString();

						MyOraDB.Parameter_Values[para_ct+37] = COM.ComVar.This_User;
		...
		{						
			...
			// Form Setting
			lbl_MainTitle.Text = "Invoice Management";
			this.Text		   = "Invoice";


			// grid set
			fgrid_main.Set_Grid("STM_INVOICE", "2", 2, COM.ComVar.This_Lang, COM.ComVar.Grid_Type.ForSearch, false);
		...
		private void Tbtn_SearchProcess()
		{
			try
			{
				if ((txt_po_no.TextLength == 0)&&(txtstyle_cd.TextLength == 0)&&(txt_invoice_no.TextLength == 0))
					return;

				this.Cursor = Cursors.WaitCursor;
                
				string vProcedure     = "PKG_STM_INVOICE.SELECT_STM_INVOICE_01";
		...
		private void GridSetColor()
		{
			...
			{				
				...
				for (int iRow = fgrid_main.Rows.Fixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					...
					vRange_1    = fgrid_main.GetCellRange(iRow, 1, iRow, _colSTYLE_NM);
					vRange_2    = fgrid_main.GetCellRange(iRow, _colGEN_NM,               iRow, _colINVOICE_SHOE_QTY);
					vRange_5    = fgrid_main.GetCellRange(iRow, _colLOT_DIV,              iRow, _colAMOUNT);
					vRange_3    = fgrid_main.GetCellRange(iRow, _colFSP,                  iRow, _colCUST_PO_NO);
					vRange_4    = fgrid_main.GetCellRange(iRow, _colCUST_PO_NO+1,		  iRow, fgrid_main.Cols.Count-1);
					...
					{						
						...
						fgrid_main.GetCellRange(iRow, _colSIZE_DIV, iRow, _colSIZE_TO).StyleNew.ForeColor = Color.DarkGray;


						vRange_3.StyleNew.ForeColor = Color.DarkGray;
					...
					else if (sLevel.Equals("2"))
					{
						...
						fgrid_main.GetCellRange(iRow, _colAIR_CHARGES).StyleNew.BackColor = Color.LightYellow;
		...
		private void add_row(int arg_sel_row)
		{
			try
			{
				...
				fgrid_main[current_row, _colTRADE_FACTORY_FOB]   = "0";
				...
				if (fgrid_main[arg_sel_row, _colGEN_CD] != null)
					fgrid_main[current_row, _colGEN_CD]         = fgrid_main[arg_sel_row, _colGEN_CD].ToString();	

				if (fgrid_main[arg_sel_row, _colSUB_CATEGORY_NAME] != null)
					fgrid_main[current_row, _colSUB_CATEGORY_NAME]  = fgrid_main[arg_sel_row, _colSUB_CATEGORY_NAME].ToString();	
				...
				_sPo_Type = fgrid_main[arg_sel_row, _colPO_TYPE].ToString();
				...
				double dTRADE_CS_FOB = Convert.ToDouble(fgrid_main[current_row, _colTRADE_CS_FOB]);

				double dTRADE_FACTORY_FOB = ClassLib.ComFunction.Calcute_Factory_FOB(dTRADE_CS_FOB, _mediation_margin);
					
				fgrid_main[current_row, _colTRADE_FACTORY_FOB] = dTRADE_FACTORY_FOB.ToString();
...
//			}
		...
		private void Make_Invoice_No(int arg_row)
		{
			...
			if (_sPo_Type == "ID")
				sInvoice_no = fgrid_main[arg_row, _colFACTORY].ToString()+
							  _sPo_Type+
			...
			else if (_sPo_Type == "QQ")
				sInvoice_no = fgrid_main[arg_row, _colFACTORY].ToString()+
							  "B"+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(2,2)+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(5,2)+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(8,2);
			else if (_sPo_Type == "PS")
				sInvoice_no = fgrid_main[arg_row, _colFACTORY].ToString()+
							  "P"+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(2,2)+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(5,2)+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(8,2);
			else if (_sPo_Type == "SS")
				sInvoice_no = fgrid_main[arg_row, _colFACTORY].ToString()+
							  "G"+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(2,2)+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(5,2)+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(8,2);
			else if (_sPo_Type == "OR")
				sInvoice_no = fgrid_main[arg_row, _colFACTORY].ToString()+
							  "O"+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(2,2)+
							  fgrid_main[arg_row, _colINVOICE_DATE].ToString().Substring(5,2)+
		...
		private bool SAVE_REPORT_REQUEST(string arg_Report_Request_Key)
		{
			try
			{
				...
				for(int iRow = _Rowfixed ; iRow < fgrid_main.Rows.Count; iRow++)
				{
					...
					if (sInvoice_no == fgrid_main[iRow, _colINVOICE_NO].ToString()) continue;
					sInvoice_no = fgrid_main[iRow, _colINVOICE_NO].ToString();
				...
				for (int iRow = _Rowfixed ; iRow < fgrid_main.Rows.Count ; iRow++)
				{
					...
					if (fgrid_main[iRow, _colCHK].ToString() == "True")
					{
					    ...
					    _ReportTag = fgrid_main[iRow, _colPO_TYPE].ToString();
					}				
				}
		...
		private void PRINT_INVOICE_TAX(string arg_report_request_key)
		{
			...
			sDir = FlexTrade.ClassLib.ComFunction.Set_RD_Directory("Form_TI_Invoice_Tax_Regular");
		...
		private bool APPLY_MERCURY_INVOICE(bool doExecute)
		{
			try
			{
				...
				for (int iRow=_Rowfixed; iRow<fgrid_main.Rows.Count; iRow++)
				{
					...
					if (myreader[9].ToString().Trim().Length > 0)
						fgrid_main[iRow, _colCONTRACT_NO]        = myreader[9].ToString();
					...
					if (myreader[12].ToString().Trim().Length > 0)
							fgrid_main[iRow, _colSEASON]         = myreader[12].ToString();
