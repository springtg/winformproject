...
//		}
		...
		public static string Set_RD_Directory(string arg_FormName)
		{
			...
			return Application.StartupPath +"\\Report\\Mold\\" + arg_FormName + ".mrd";
		}
		...
		public static bool SAVE_SYS_PGM_MON(bool doExecute)
		{
			COM.OraDB oraDB = new COM.OraDB();
			...
			try
			{
				...
				oraDB.Process_Name = "PKG_SYS_PGM_MON.SAVE_SYS_PGM";
				
				oraDB.Parameter_Name[0] = "ARG_USR_ID" ;
				oraDB.Parameter_Name[1] = "ARG_MC_ID" ;
				oraDB.Parameter_Name[2] = "ARG_PGM" ;
				oraDB.Parameter_Name[3] = "ARG_WIN_ID" ;
				oraDB.Parameter_Name[4] = "ARG_ACTION" ;
				oraDB.Parameter_Name[5] = "ARG_REF1" ;
				oraDB.Parameter_Name[6] = "ARG_REF2" ;
				oraDB.Parameter_Name[7] = "ARG_REF3" ;
				...
				oraDB.Parameter_Values[1] = FlexMold.ClassLib.ComVar.This_Computer;
				oraDB.Parameter_Values[2] = FlexMold.ClassLib.ComVar.This_PGM;
				oraDB.Parameter_Values[3] = FlexMold.ClassLib.ComVar.This_Win_ID;
				oraDB.Parameter_Values[4] = FlexMold.ClassLib.ComVar.This_Action;
				oraDB.Parameter_Values[5] = FlexMold.ClassLib.ComVar.This_Packages;
				oraDB.Parameter_Values[6] = FlexMold.ClassLib.ComVar.This_REF2;
				oraDB.Parameter_Values[7] = FlexMold.ClassLib.ComVar.This_REF3;
		...
		public static DataTable SELECT_SCM_ITEM_LIST(string arg_value)
		{
			COM.OraDB oraDB = new COM.OraDB();

			string Proc_Name = "PKG_SVM_SM_PUR_REPORT.SELECT_SVM_SM_ITEM_MASTER";
		...
		public static DataTable SELECT_SCM_MAIN_SUB_LIST(string arg_main , string arg_value)
		{
			COM.OraDB oraDB = new COM.OraDB();

			string Proc_Name = "PKG_SVM_SM_PUR_REPORT.SELECT_SVM_SM_MAIN_MASTER";

			oraDB.ReDim_Parameter(3);
			oraDB.Process_Name = Proc_Name ;
			
			oraDB.Parameter_Name[0] = "ARG_MAIN_SUB";
			oraDB.Parameter_Name[1] = "ARG_VALUE";
			oraDB.Parameter_Name[2] = "OUT_CURSOR";
			...
			oraDB.Parameter_Values[0] = COM.ComFunction.Empty_String(arg_main," ");
			oraDB.Parameter_Values[1] = COM.ComFunction.Empty_String(arg_value," ");
			oraDB.Parameter_Values[2] = "";
		...
		public static DataTable Select_User_Charge(string arg_factory)
		{
			COM.OraDB oraDB = new COM.OraDB();

			string Proc_Name = "PKG_SVM_SM_PURCHASE_ORDER.SELECT_SVM_SM_USER";
