...
{
	public class Form_PB_Mold_Monthlly_Amount_Report : COM.MoldWinForm.Form_Top
	{
		...
		public Form_PB_Mold_Monthlly_Amount_Report()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_PB_Mold_Monthlly_Amount_Report));
			...
			this.dtpdate_to.Location = new System.Drawing.Point(408, 9);
			...
			this.CboLine_CD.Location = new System.Drawing.Point(408, 40);
			...
			this.CboLine_CD.Size = new System.Drawing.Size(120, 24);
			this.CboLine_CD.TabIndex = 30;
			this.CboLine_CD.Visible = false;
			// 
			// lbl15
			// 
			...
			this.lbl15.Location = new System.Drawing.Point(340, 45);
			...
			this.cmb_repairarea1.Location = new System.Drawing.Point(141, 40);
			...
			this.lbl_repairarea.Location = new System.Drawing.Point(8, 44);
			...
			// 
			// Form_PB_Mold_Monthlly_Amount_Report
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.panel1);
			this.Name = "Form_PB_Mold_Monthlly_Amount_Report";
			this.Load += new System.EventHandler(this.Form_PB_Mold_Monthlly_Amount_Report_Load);
		...
		private void Form_PB_Mold_Monthlly_Amount_Report_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		...
		{
			cbo_factory.Text = "VJ";
			this.lbl_MainTitle.Text = "Mold Repairing Monthly Amount Report";
		...
		{
			string mrd_Filename;
			mrd_Filename = FlexMold.ClassLib.ComFunction.Set_RD_Directory("Form_Mold_Month_Total");
			if ((cmb_repairarea1.SelectedValue.ToString() == "10")||(cmb_repairarea1.SelectedValue.ToString() == "30")||(cmb_repairarea1.SelectedValue.ToString() == "40")||(cmb_repairarea1.SelectedValue.ToString() == "50"))
				mrd_Filename = FlexMold.ClassLib.ComFunction.Set_RD_Directory("Form_Mold_Month_Total_Fty4");
			else if ((cmb_repairarea1.SelectedValue.ToString() == "20")||(cmb_repairarea1.SelectedValue.ToString() == "30")||(cmb_repairarea1.SelectedValue.ToString() == "40")||(cmb_repairarea1.SelectedValue.ToString() == "50"))
				mrd_Filename = FlexMold.ClassLib.ComFunction.Set_RD_Directory("Form_Mold_Month_Total_Fty3");
			else
			{
				MessageBox.Show("Please choose Repair Area. ");
				return;
			}
...
////			{	
////				mrd_Filename = FlexMold.ClassLib.ComFunction.Set_RD_Directory("Form_Mold_Month_By_NITC");
////			}
////
//			else 
//			{
...
//			}
			...
			if((cmb_repairarea1.Text == "")||(cmb_repairarea1.Columns[0].Text == "ALL"))
				...
				aHead[3] = cmb_repairarea1.Columns[0].Text;
			
			aHead[4] = cmb_repairarea1.Columns[1].Text;
			#endregion
