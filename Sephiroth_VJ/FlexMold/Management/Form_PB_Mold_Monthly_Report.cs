...
{
	public class Form_PB_Mold_Monthly_Report : COM.MoldWinForm.Form_Top
	{
		...
		public Form_PB_Mold_Monthly_Report()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Form_PB_Mold_Monthly_Report));
			...
			// 
			// Form_PB_Mold_Monthly_Report
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
			this.ClientSize = new System.Drawing.Size(1016, 666);
			this.Controls.Add(this.panel1);
			this.Name = "Form_PB_Mold_Monthly_Report";
			this.Load += new System.EventHandler(this.Form_PB_Mold_Monthly_Report_Load);
		...
		private void Form_PB_Mold_Monthly_Report_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		...
		{
			cbo_factory.Text = "VJ";
			this.lbl_MainTitle.Text = "Mold Repairing Monthly Report";
		...
		private void tbtn_Print_Click(object sender, C1.Win.C1Command.ClickEventArgs e)
		{
			...
			if (CboLine_CD.Columns[0].Text == "105")
				mrd_Filename = FlexMold.ClassLib.ComFunction.Set_RD_Directory("Form_Mold_Month_By_Fty3");
			else if (CboLine_CD.Columns[0].Text == "107")
			{	
				mrd_Filename = FlexMold.ClassLib.ComFunction.Set_RD_Directory("Form_Mold_Month_By_Fty4");
			}
