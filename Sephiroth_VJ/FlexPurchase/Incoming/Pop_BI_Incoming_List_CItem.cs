...
namespace FlexPurchase.Incoming
{
	...
	/// </summary>
	public class Pop_BI_Incoming_List_CItem : System.Windows.Forms.UserControl
	{
		...
		#region 생성자 / 소멸자
		public Pop_BI_Incoming_List_CItem()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_BI_Incoming_List_CItem));
			...
			this.cmb_value.Location = new System.Drawing.Point(125, 33);
			...
			this.Name = "Pop_BI_Incoming_List_CItem";
		...
		private void Init_Form()
		{
			...
			string[] vText  = (string[])(ClassLib.ComVar.Parameter_PopUp_Object2[0]);

//			string[] str = new string[1];
//			string[] vData = (string[])ClassLib.ComVar.Parameter_PopUp_Object;

			ClassLib.ComFunction.CreateComboBox(cmb_value, vData, vText);
			cmb_value.Splits[0].DisplayColumns[0].Visible = false;
            if(cmb_value.ListCount > 0) cmb_value.SelectedIndex = 0;
		...
		private void btn_apply_Click(object sender, System.EventArgs e)
		{
			...
			COM.ComVar.Parameter_PopUp[0]	= cmb_value.Text.ToString().Trim(); 
