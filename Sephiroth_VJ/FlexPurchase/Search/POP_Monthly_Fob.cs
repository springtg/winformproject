...
{
	public class POP_Monthly_Fob : COM.OrderWinForm.Pop_Small
	{
		...
		private System.Windows.Forms.MenuItem mnt_Delete_Row;
		private System.Windows.Forms.MenuItem mnt_Insert_Row;
		private System.ComponentModel.IContainer components = null;

		public POP_Monthly_Fob()
		{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(POP_Monthly_Fob));
			...
			this.mnt_Delete_Row = new System.Windows.Forms.MenuItem();
			...
			this.mnt_Insert_Row = new System.Windows.Forms.MenuItem();
			...
			this.txt_Month.Location = new System.Drawing.Point(108, 52);
			...
			// mnt_Delete_Row
			// 
			this.mnt_Delete_Row.Index = 0;
			this.mnt_Delete_Row.Text = "Delete Row";
			this.mnt_Delete_Row.Click += new System.EventHandler(this.mnt_Delete_Row_Click);
			// 
			// label3
			// 
			...
			this.lbl_Close.Location = new System.Drawing.Point(284, 387);
			this.lbl_Close.Name = "lbl_Close";
			this.lbl_Close.Size = new System.Drawing.Size(100, 21);
			this.lbl_Close.TabIndex = 181;
			...
			this.lbl_Save.Location = new System.Drawing.Point(3, 387);
			this.lbl_Save.Name = "lbl_Save";
			this.lbl_Save.Size = new System.Drawing.Size(100, 21);
			this.lbl_Save.TabIndex = 180;
			...
			// mnt_Insert_Row
			// 
			this.mnt_Insert_Row.Index = 1;
			this.mnt_Insert_Row.Text = "Insert Row";
			this.mnt_Insert_Row.Click += new System.EventHandler(this.mnt_Insert_Row_Click);
			// 
			// POP_Monthly_Fob
			// 
			...
			this.Name = "POP_Monthly_Fob";
			this.Load += new System.EventHandler(this.POP_Monthly_Fob_Load);
		...
		private void Init_Form()
		{
			...
			//Setting  Title
			this.Text = "Monthly Fob";
			this.lbl_MainTitle.Text =  "Monthly Fob";
			ClassLib.ComFunction.SetLangDic(this);

			//Setting Grid( TBSEM_FOB)
			fgrid_Main.Set_Grid( "SEM_FOB", "1", 1, ClassLib.ComVar.This_Lang, COM.ComVar.Grid_Type.ForModify, false);
			fgrid_Main.Font = new Font("Verdana",8);
			//fgrid_Main.Set_Action_Image(img_Action); 

			txt_Factory.Text   = ClassLib.ComVar.Parameter_PopUp[0];
			txt_Month.Text     = "20"+ClassLib.ComVar.Parameter_PopUp[1].Substring(2,2).ToString();
		...
		private void lbl_Save_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				DialogResult vDr = MessageBox.Show("Do you want to save Fob?", "Monthly Fob", MessageBoxButtons.YesNo);


				if ((fgrid_Main[fgrid_Main.Rows.Count -1, (int)ClassLib.TBSEM_FOB.lxFOB_MONTH] ==null) ||
					(fgrid_Main[fgrid_Main.Rows.Count -1, (int)ClassLib.TBSEM_FOB.lxFOB_MONTH].ToString().Length < 6)) 
				...
				if (vDr == DialogResult.Yes)
				{
					SAVE_SEM_FOB();
					fgrid_Main.Rows.Count  = fgrid_Main.Rows.Count  + 1; 
					fgrid_Main[fgrid_Main.Rows.Count-1,(int)ClassLib.TBSEM_FOB.lxFACTORY ] = txt_Factory.Text;
				}
		...
		{
			//fgrid_Main[fgrid_Main.Selection.r1,0] = "I";
			fgrid_Main.Select(fgrid_Main.Selection.r1, fgrid_Main.Selection.c1);
		...
		private void mnt_Delete_Row_Click(object sender, System.EventArgs e)
		{
		...
		private void mnt_Insert_Row_Click(object sender, System.EventArgs e)
		{
			fgrid_Main.Rows.Count  = fgrid_Main.Rows.Count  +1; 
		}
		...
		/// </summary>
		private DataTable SELECT_SEM_FOB()
		{
			DataSet ds_ret;

			string process_name = "PKG_SEM_MNT.SELECT_SEM_FOB";
			...
			MyOraDB.Parameter_Values[1]  = txt_Month.Text;
		...
		private bool SAVE_SEM_FOB()
		{
			...
			try
			{
				...
				MyOraDB.Process_Name = "PKG_SEM_MNT.SAVE_SEM_FOB";
				...
				MyOraDB.Parameter_Name[3]  = "ARG_FOB"; 
				...
				for (int i = fgrid_Main.Rows.Fixed ;  i< fgrid_Main.Rows.Count ; i++) 
				{
					...
					MyOraDB.Parameter_Values[vValue++]  = fgrid_Main[i,(int)ClassLib.TBSEM_FOB.lxFACTORY].ToString().Trim();
					MyOraDB.Parameter_Values[vValue++]  = fgrid_Main[i,(int)ClassLib.TBSEM_FOB.lxFOB_MONTH].ToString().Trim();
					MyOraDB.Parameter_Values[vValue++]  = fgrid_Main[i,(int)ClassLib.TBSEM_FOB.lxFOB].ToString().Trim();
		...
		private void POP_Monthly_Fob_Load(object sender, System.EventArgs e)
		{
			Init_Form();
		}
