...
{
	public class Pop_BK_Outside_Stock_Print : COM.PCHWinForm.Pop_Small
	{
		...
		public Pop_BK_Outside_Stock_Print()
		{
			InitializeComponent();
		}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pop_BK_Outside_Stock_Print));
		...
		{;
			try
			{
				...
				if (cmb_printType.SelectedValue.ToString().Equals("10"))
					mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_Outside_Stock_P1.mrd";
				else
					mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_Outside_Stock_P2.mrd";
