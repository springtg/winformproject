...
{
	public class Pop_BK_Stock_Report_Print : COM.PCHWinForm.Pop_Small
	{
		...
		public Pop_BK_Stock_Report_Print()
		{
			InitializeComponent();
		}
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Pop_BK_Stock_Report_Print));
		...
		{;
			try
			{
				...
				string mrd_Filename = Application.StartupPath + @"\" + @"Report\Material\Form_BK_Stock_Report_" + printType + ".mrd";
				string Para         = " ";
				...
				string stock_ymd_from = ClassLib.ComVar.Parameter_PopUp[1];
				string stock_ymd_to = ClassLib.ComVar.Parameter_PopUp[2];

				aHead[0]    = stock_ymd_from;
				aHead[1]    = stock_ymd_to;
				aHead[2]    = factory;
		...
		private void Init_Form()
		{
			...
			{
				// print type
				DataTable vDt = ClassLib.ComVar.Select_ComCode(COM.ComVar.This_Factory, "SBK06");
