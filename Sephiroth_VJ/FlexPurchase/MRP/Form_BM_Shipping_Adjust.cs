...
namespace FlexMRP.MRP
{
	public class Form_BM_Shipping_Adjust : COM.PCHWinForm.Form_Top, IOperation
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_BM_Shipping_Adjust));
        ...
        private void fgrid_main_DragDrop(object sender, DragEventArgs e)
        {
            try
            {
        ...
        private void fgrid_main_DragOver(object sender, DragEventArgs e)
        {
            try
            {
                // 선택구간
		...
		public void CheckStatus()
		{
            ...
            //unusable button  - 2010.09.03
            mnu_air.Enabled = false;
            mnu_jit.Enabled = false;
            mnu_remainder.Enabled = false;
            mnu_mrpRedeploy.Enabled = false;
		}
