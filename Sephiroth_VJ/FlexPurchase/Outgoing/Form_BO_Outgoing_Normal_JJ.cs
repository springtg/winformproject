...
{
	public class Form_BO_Outgoing_Normal_JJ : COM.PCHWinForm.Form_Top
	{
		...
		public Form_BO_Outgoing_Normal_JJ()
		{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_BO_Outgoing_Normal_JJ));
            ...
            // 
            // Form_BO_Outgoing_Normal_JJ
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(7, 15);
            this.ClientSize = new System.Drawing.Size(1016, 666);
            this.Controls.Add(this.c1Sizer1);
            this.Name = "Form_BO_Outgoing_Normal_JJ";
            this.Load += new System.EventHandler(this.Form_Load);
            this.Closed += new System.EventHandler(this.Form_Closed);
            this.Closing += new System.ComponentModel.CancelEventHandler(this.Form_BO_Outgoing_Normal_JJ_Closing);
		...
		private void Form_BO_Outgoing_Normal_JJ_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
		...
		private void cmb_OutDiv_SelectedValueChanged(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                if (cmb_OutDiv.SelectedValue.ToString() == _OutDiv_Defective)
				{
...
//				}
			...
			string arg_upd_user)
		{
			...
			try
			{
                ...
                if (arg_out_division == _OutDiv_Defective)   //miyoung.kim
				{
                    MyOraDB.Process_Name = "PKG_SBO_OUTGOING_PRODUCTION.RUN_OUT_USAGE_DEFECTIVE_JJ"; 
				}
				else
				{
                    MyOraDB.Process_Name = "PKG_SBO_OUTGOING_PRODUCTION.RUN_OUT_USAGE_NORMAL_JJ";
