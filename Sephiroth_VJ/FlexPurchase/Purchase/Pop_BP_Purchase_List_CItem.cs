...
{
	/// <summary>
	/// Pop_BP_Purchase_List_CItem에 대한 요약 설명입니다.
	/// </summary>
	public class Pop_BP_Purchase_List_CItem : System.Windows.Forms.UserControl
	{
		...
		public Pop_BP_Purchase_List_CItem()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(Pop_BP_Purchase_List_CItem));
			...
			this.Name = "Pop_BP_Purchase_List_CItem";
		...
		private void btn_apply_Click(object sender, System.EventArgs e)
		{
			...
			//if(lbl_item.Text.ToString() == "Work Div")
			//	COM.ComVar.Parameter_PopUp[0]	= Convert.ToString(cmb_value.SelectedIndex);
			//else
